...
#define CONFIG_HLP_CALIBRATED    "Enable the use of calibrated radio APIs"
...
#define CMDLINE_PARAMS_DESC {  \
  ...
  {"calibrated-radio",      CONFIG_HLP_CALIBRATED,    PARAMFLAG_BOOL, .iptr=&softmodem_params.calibrated_radio, .defintval=0,           TYPE_INT,    0}, \
}
// clang-format on
