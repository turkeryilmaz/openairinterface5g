...
#define CONFIG_HLP_NTN_TRS       "softmodem params for ntn t-Reassembly timer in RLC AM and UM\n"
#define CONFIG_HLP_NTN_TRS_OFFSET  "softmodem params for ntn t-Reassembly timer offset in ms\n"
#define CONFIG_HLP_NTN_TRD       "softmodem params for ntn t-Reordering timer in PDCP\n"
