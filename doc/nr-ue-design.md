...
UE uses actors which are threads dedicated to particular activity. UL actor handles PHY procedures for PUSCH, PUCCH and PRACH. Sync Actor handles initial sync. DL Actors handle DLSCH PHY procedures.
