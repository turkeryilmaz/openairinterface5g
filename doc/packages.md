...
```
cat <<EOF | sudo tee /etc/apt/sources.list.d/oai.sources
Types: deb
...
```
 ...
 ```
cat <<EOF > /etc/yum.repos.d/oai.repo
[gitlab-rpms]
...
dnf clean all
dnf makecache
dnf install openairinterface-liboai-common-1.0.0-1.x86_64 openairinterface-liboai-usrp-1.0.0-1.x86_64 openairinterface-oai-lte-1.0.0-1.x86_64 openairinterface-oai-nr-1.0.0-1.x86_64 openairinterface-oai-physim-1.0.0-1.x86_64
```