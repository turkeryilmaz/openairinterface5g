...
OAI_MEMPROF_WRAPPER_ATTRIBUTES void *__wrap_aligned_alloc(size_t alignment, size_t size)
{
  ...
  const bool admitted = oai_memprof_active_runtime_begin_v1(6, (uint64_t)size, true, &ticket);
