...
typedef enum {
  ...
  FLIGHT_EVENT_RADIO_TX_RELATIVE_POWER = 58,
  FLIGHT_EVENT_RADIO_TX_RELATIVE_QUALITY = 59,
  FLIGHT_EVENT_RADIO_TX_RELATIVE_CONFIG = 60,
  FLIGHT_EVENT_RADIO_TX_RELATIVE_ERASURE = 61,
  FLIGHT_EVENT_UE_TX_RELATIVE_BOUNDS = 62,
  FLIGHT_EVENT_RADIO_TX_RELATIVE_SAMPLES = 63,
  FLIGHT_EVENT_RADIO_TX_RELATIVE_GATE = 64,
