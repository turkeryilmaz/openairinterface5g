...
sudo -E "$cuBB_Path"/build_x86/cuPHY-CP/cuphycontroller/examples/cuphycontroller_scf $argument
sudo ./build_x86/cuPHY-CP/gt_common_libs/nvIPC/tests/pcap/pcap_collect nvipc /tmp
