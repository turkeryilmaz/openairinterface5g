                              ...
                              simde__m256i in1)
{
    ...
    in0 = simde_mm256_shufflelo_epi16(in0,0xd8); // SIMDE_MM_SHUFFLE(0,2,1,3));
    in0 = simde_mm256_shufflehi_epi16(in0,0xd8); // SIMDE_MM_SHUFFLE(0,2,1,3));
    in0 = simde_mm256_shuffle_epi32(in0,0xd8); // SIMDE_MM_SHUFFLE(0,2,1,3));

    in1 = simde_mm256_shufflelo_epi16(in1,0xd8); // SIMDE_MM_SHUFFLE(0,2,1,3));
    in1 = simde_mm256_shufflehi_epi16(in1,0xd8); // SIMDE_MM_SHUFFLE(0,2,1,3));
    in1 = simde_mm256_shuffle_epi32(in1,0xd8); // SIMDE_MM_SHUFFLE(0,2,1,3));
