...
void transpose (int N, float complex *A, float complex *Result)
{
  ...
  if (transb == CblasNoTrans) {
    B = (float complex*)calloc_or_fail(ldb * col_opB, sizeof(float complex));
    col_B= col_opB;
  }
  else {
    B = (float complex*)calloc_or_fail(ldb * col_opA, sizeof(float complex));
    col_B = col_opA;
  }
  float complex* C = (float complex*)malloc_or_fail(ldc * col_opB * sizeof(float complex));
...
void H_hermH_plus_sigma2I (int N, int M, float complex *A, float sigma2, float complex *Result)
{
  ...
  float complex* C = (float complex*)calloc_or_fail(ldc * col_opB, sizeof(float complex));
 ...
 void HH_herm_plus_sigma2I (int M, int N, float complex *A, float sigma2, float complex *Result)
{
  ...
  float complex* C = (float complex*)calloc_or_fail(M * M, sizeof(float complex));
...
void eigen_vectors_values (int N, float complex *A, float complex *Vectors, float *Values_Matrix)
{
  ...
  int lda = N;
  int i;
  float* Values = (float*)malloc_or_fail(sizeof(float) * 1 * N);
