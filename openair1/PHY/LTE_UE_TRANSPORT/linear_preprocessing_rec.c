...
// Commented the (if defined) section since it is not compiling on UBUNTU
// meanwhile tested on Red Hat Enterprise Linux release 9.4 (Plow) and it is compiling
// subsequent enum has been added to CBLAS_TRANSPOSE 
