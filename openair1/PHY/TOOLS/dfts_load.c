...
uint32_t DFT_SCALING_1024[5][4] = {{4,1,0,0},{3,2,0,0},{1,2,1,1},{1,2,0,2},{1,1,0,3}};
uint32_t DFT_SCALING_1536[5][5] = {{1,1,2,2,0},{1,1,2,2,0},{1,1,2,2,0},{1,1,2,2,0},{1,1,2,2,0}};
uint32_t DFT_SCALING_2048[5][5] = {{1,4,1,0,0},{1,3,2,0,0},{1,1,2,1,1},{1,1,2,0,2},{1,1,1,0,3}};
uint32_t DFT_SCALING_3072[5][5] = {{1,4,1,0,0},{1,0,3,2,0},{1,0,3,2,0},{1,0,3,2,0},{1,0,3,2,0}};
uint32_t DFT_SCALING_4096[5][5] = {{1,2,3,0,0},{0,3,3,0,0},{0,2,4,0,0},{0,0,3,3,0},{0,0,0,3,3}};
