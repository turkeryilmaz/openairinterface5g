...
uint32_t DFT_SCALING_512_THRES[7] = {53,57,59,63,65,69,100};
...
uint32_t DFT_SCALING_1024_THRES[5] = {49,55,63,69,100};
...
uint32_t DFT_SCALING_2048_THRES[10] = {47,49,53,55,59,61,65,67,69,100};
uint32_t DFT_SCALING_2048[10][5] = {{6,0,0,0,0},{5,1,0,0,0},{5,0,1,0,0},{4,1,1,0,0},{4,0,1,1,0},{3,1,1,1,0},{3,0,1,1,1},{2,1,1,1,1},{2,0,2,0,2},{1,0,1,0,4}};
uint32_t DFT_SCALING_3072[5][5] = {{1,4,1,0,0},{1,0,3,2,0},{1,0,3,2,0},{1,0,3,2,0},{1,0,3,2,0}};
uint32_t DFT_SCALING_4096_THRES[8] = {43,49,57,61,63,65,69,100};
...
uint32_t IDFT_SCALING_1536[4] = {1,1,2,2};
