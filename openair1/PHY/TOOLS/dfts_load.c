...
uint32_t DFT_SCALING_512_THRES[7] = {53,57,59,63,65,69,71};
...
uint32_t DFT_SCALING_1024_THRES[5] = {49,55,63,69,71};
...
uint32_t DFT_SCALING_2048_THRES[10] = {47,49,53,55,59,61,65,67,69,71};
...
uint32_t DFT_SCALING_4096_THRES[8] = {43,49,57,61,63,65,69,71};
