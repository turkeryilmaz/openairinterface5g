...
//#define DEBUG_PSBCH_TX
//#define DEBUG_PSBCH_TX_DATA
//#define DUMP_PSBCH_TX_SAMPLES
...
void nr_tx_psbch(PHY_VARS_NR_UE *UE, uint32_t frame_tx, uint32_t slot_tx, c16_t **txF) {
  ...
  uint32_t *psbch_payload = &sl_ue_phy_params->psbch_tx.psbch_payload;
...
#ifdef SL_DUMP_PSBCH_TX_SAMPLES
  LOG_M("sl_psbch_block.m", "sl_txF", (void*)UE->common_vars.txdataF[0], symbol_size*14, 1, 1);
#endif
