                      ...
                      int nb_pusch)
{
  ...
  for (uint8_t pusch_id = 0; pusch_id < nb_pusch; pusch_id++) {
    ...
    nrLDPC_TB_decoding_parameters.harq_unique_pid = ULSCH_id;
  ...
  int ret_decoder = phy_vars_gNB->nrLDPC_coding_interface.nrLDPC_coding_decoder(&nrLDPC_slot_decoding_parameters);
