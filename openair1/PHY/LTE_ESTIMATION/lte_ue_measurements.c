...
{
  unsigned short rb;
  simde__m128i *after_mf_00_128,*after_mf_01_128, *after_mf_10_128, *after_mf_11_128, ad_re_128, bc_re_128;
       ...
       simde__m128i pmi128_re,pmi128_im,mmtmpPMI0,mmtmpPMI1 /* ,mmtmpPMI2,mmtmpPMI3 */ ;
        ...
        for (subband=0; subband<nb_subbands; subband++) {
          ...
          for (i=0; i<limit; i++) {
            ...
            mmtmpPMI1 = simde_mm_shufflelo_epi16(dl_ch1_128[0],_MM_SHUFFLE(2,3,0,1));
              //  print_ints("_mm_shufflelo_epi16",&mmtmpPMI1);
            mmtmpPMI1 = simde_mm_shufflehi_epi16(mmtmpPMI1,_MM_SHUFFLE(2,3,0,1));
