...
decodeULSCH.TargetCodeRate = 567 / 1024;
...
ackbits = nrUCIDecode(cack,oack);
% Display the decoded UCI bits
disp('Decoded ACK bits:');
disp(ackbits);

csibits = nrUCIDecode(ccsi1,ocsi1);
% Display the decoded CSI bits
disp('Decoded CSI bits:');
disp(csibits);
