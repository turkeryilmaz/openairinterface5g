...
typedef struct {
  ...
  uint8_t channel_matrix[12*272*2*8*4];    // Array of (NR_NB_SC_PER_RB*(numPRGs*Nu*Ng)) entries of the type denoted by iqRepresentation H{PRG pI} [ueAntenna uI, gNB antenna gI] = array[uI*Ng*Np + gI*Np + pI]; uI: 0…Nu-1 (UE antenna index); gI: 0…Ng-1 (gNB antenna index); pI: 0…Np-1 (PRG index)
