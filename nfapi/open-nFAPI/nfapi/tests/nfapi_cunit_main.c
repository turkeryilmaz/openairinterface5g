...
extern int nfapi_test_unpack_vendor_extension_tlv(nfapi_tl_t* tl, uint8_t **ppReadPackedMsg, uint8_t *end, void** ve, nfapi_p4_p5_codec_config_t* config)
{
  ...
  if (tl->tag == NFAPI_VENDOR_EXTENSION_MIN_TAG_VALUE) {
    ...
    if (!(pull16(ppReadPackedMsg, &mve->value1, end) && pull32(ppReadPackedMsg, &mve->value2, end))) {
      free(mve);
      return 0;
    }
...
extern int nfapi_test_pack_vendor_extension_tlv(void* ve, uint8_t **ppWritePackedMsg, uint8_t *end, nfapi_p4_p5_codec_config_t* config)
{
  ...
  return (push16(mve->value1, ppWritePackedMsg, end) && push32(mve->value2, ppWritePackedMsg, end));
}
  ...
  if (memcmp(&pnfConfigRequest_in, &pnfConfigRequest_out, sizeof(nfapi_pnf_config_request_t)) == 0) {
    ...
    if (pnfConfigRequest_in.header.message_id != pnfConfigRequest_out.header.message_id) {
      printf("Mismatch: packed message id %d, unpacked message id %d\n",
             pnfConfigRequest_in.header.message_id,
             pnfConfigRequest_out.header.message_id);
    }
    if (pnfConfigRequest_in.header.message_length != pnfConfigRequest_out.header.message_length) {
      printf("Mismatch: packed message_length %d, unpacked message_length %d\n",
             pnfConfigRequest_in.header.message_length,
             pnfConfigRequest_out.header.message_length);
    }
    if (pnfConfigRequest_in.header.phy_id != pnfConfigRequest_out.header.phy_id) {
      printf("Mismatch: packed phy_id %d, unpacked phy_id %d\n",
             pnfConfigRequest_in.header.phy_id,
             pnfConfigRequest_out.header.phy_id);
    }
    if (pnfConfigRequest_in.pnf_phy_rf_config.number_phy_rf_config_info
        != pnfConfigRequest_out.pnf_phy_rf_config.number_phy_rf_config_info) {
      printf("Mismatch: packed number_phy_rf_config_info %d, unpacked number_phy_rf_config_info %d\n",
             pnfConfigRequest_in.pnf_phy_rf_config.number_phy_rf_config_info,
             pnfConfigRequest_out.pnf_phy_rf_config.number_phy_rf_config_info);
    }

    for (i = 0; i < NFAPI_MAX_PHY_RF_INSTANCES; i++) {
      if (pnfConfigRequest_in.pnf_phy_rf_config.phy_rf_config[i].phy_id
          != pnfConfigRequest_out.pnf_phy_rf_config.phy_rf_config[i].phy_id) {
        printf("Mismatch: rf idx %d, packed phy id %d, unpacked phy id %d\n",
               i,
               pnfConfigRequest_in.pnf_phy_rf_config.phy_rf_config[i].phy_id,
               pnfConfigRequest_out.pnf_phy_rf_config.phy_rf_config[i].phy_id);
      }
      if (pnfConfigRequest_in.pnf_phy_rf_config.phy_rf_config[i].phy_config_index
          != pnfConfigRequest_out.pnf_phy_rf_config.phy_rf_config[i].phy_config_index) {
        printf("Mismatch: rf idx %d, packed phy_config_index %d, unpacked phy_config_index %d\n",
               i,
               pnfConfigRequest_in.pnf_phy_rf_config.phy_rf_config[i].phy_config_index,
               pnfConfigRequest_out.pnf_phy_rf_config.phy_rf_config[i].phy_config_index);
      }
      if (pnfConfigRequest_in.pnf_phy_rf_config.phy_rf_config[i].rf_config_index
          != pnfConfigRequest_out.pnf_phy_rf_config.phy_rf_config[i].rf_config_index) {
        printf("Mismatch: rf idx %d, packed rf_config_index %d, unpacked rf_config_index %d\n",
               i,
               pnfConfigRequest_in.pnf_phy_rf_config.phy_rf_config[i].rf_config_index,
               pnfConfigRequest_out.pnf_phy_rf_config.phy_rf_config[i].rf_config_index);
      }
    }
    return 0;
...
void nfapi_test_pnf_config_req(void) 
{
  ...
  /*Pack pnf config req*/
  packedMessageLength = nfapi_p5_message_pack(&pnfConfigRequest_in,
                                              sizeof(nfapi_pnf_config_request_t),
                                              gTestNfapiMessageTx,
                                              MAX_PACKED_MESSAGE_SIZE,
                                              0);
...
void nfapi_test_cell_search_indication_lte()
{
  ...
  CU_ASSERT_EQUAL(in.lte_cell_search_indication.number_of_lte_cells_found,
                  out.lte_cell_search_indication.number_of_lte_cells_found);

  for (idx = 0; idx < out.lte_cell_search_indication.number_of_lte_cells_found; ++idx) {
    CU_ASSERT_EQUAL(in.lte_cell_search_indication.lte_found_cells[idx].pci,
                    out.lte_cell_search_indication.lte_found_cells[idx].pci);
    CU_ASSERT_EQUAL(in.lte_cell_search_indication.lte_found_cells[idx].rsrp,
                    out.lte_cell_search_indication.lte_found_cells[idx].rsrp);
    CU_ASSERT_EQUAL(in.lte_cell_search_indication.lte_found_cells[idx].rsrq,
                    out.lte_cell_search_indication.lte_found_cells[idx].rsrq);
    CU_ASSERT_EQUAL(in.lte_cell_search_indication.lte_found_cells[idx].frequency_offset,
                    out.lte_cell_search_indication.lte_found_cells[idx].frequency_offset);
  }
...
void nfapi_test_cell_search_indication_utran()
{
  ...
  CU_ASSERT_EQUAL(in.error_code, out.error_code);
  CU_ASSERT_EQUAL(in.utran_cell_search_indication.tl.tag, out.utran_cell_search_indication.tl.tag);
  CU_ASSERT_EQUAL(in.utran_cell_search_indication.number_of_utran_cells_found,
                  out.utran_cell_search_indication.number_of_utran_cells_found);

  for (idx = 0; idx < out.utran_cell_search_indication.number_of_utran_cells_found; ++idx) {
    CU_ASSERT_EQUAL(in.utran_cell_search_indication.utran_found_cells[idx].psc,
                    out.utran_cell_search_indication.utran_found_cells[idx].psc);
    CU_ASSERT_EQUAL(in.utran_cell_search_indication.utran_found_cells[idx].rscp,
                    out.utran_cell_search_indication.utran_found_cells[idx].rscp);
    CU_ASSERT_EQUAL(in.utran_cell_search_indication.utran_found_cells[idx].ecno,
                    out.utran_cell_search_indication.utran_found_cells[idx].ecno);
    CU_ASSERT_EQUAL(in.utran_cell_search_indication.utran_found_cells[idx].frequency_offset,
                    out.utran_cell_search_indication.utran_found_cells[idx].frequency_offset);
  }
...
void nfapi_test_cell_search_indication_geran()
{
  ...
  CU_ASSERT_EQUAL(in.error_code, out.error_code);
  CU_ASSERT_EQUAL(in.geran_cell_search_indication.tl.tag, out.geran_cell_search_indication.tl.tag);
  CU_ASSERT_EQUAL(in.geran_cell_search_indication.number_of_gsm_cells_found,
  ...
  for (idx = 0; idx < out.geran_cell_search_indication.number_of_gsm_cells_found; ++idx) {
    CU_ASSERT_EQUAL(in.geran_cell_search_indication.gsm_found_cells[idx].arfcn,
                    out.geran_cell_search_indication.gsm_found_cells[idx].arfcn);
    CU_ASSERT_EQUAL(in.geran_cell_search_indication.gsm_found_cells[idx].bsic,
                    out.geran_cell_search_indication.gsm_found_cells[idx].bsic);
    CU_ASSERT_EQUAL(in.geran_cell_search_indication.gsm_found_cells[idx].rxlev,
                    out.geran_cell_search_indication.gsm_found_cells[idx].rxlev);
    CU_ASSERT_EQUAL(in.geran_cell_search_indication.gsm_found_cells[idx].rxqual,
                    out.geran_cell_search_indication.gsm_found_cells[idx].rxqual);
    CU_ASSERT_EQUAL(in.geran_cell_search_indication.gsm_found_cells[idx].frequency_offset,
                    out.geran_cell_search_indication.gsm_found_cells[idx].frequency_offset);
    CU_ASSERT_EQUAL(in.geran_cell_search_indication.gsm_found_cells[idx].sfn_offset,
                    out.geran_cell_search_indication.gsm_found_cells[idx].sfn_offset);
  }
...
void nfapi_test_broadcast_detect_indication_lte()
{
  ...
  CU_ASSERT_EQUAL(in.lte_broadcast_detect_indication.number_of_tx_antenna,
                  out.lte_broadcast_detect_indication.number_of_tx_antenna);
...
void nfapi_test_broadcast_detect_indication_nb_iot()
{
  ...
  CU_ASSERT_EQUAL(in.nb_iot_broadcast_detect_indication.number_of_tx_antenna,
                  out.nb_iot_broadcast_detect_indication.number_of_tx_antenna);
...
void nfapi_test_system_information_schedule_request_lte()
{
  ...
  CU_ASSERT_EQUAL(in.lte_system_information_schedule_request.downlink_channel_bandwidth,
                  out.lte_system_information_schedule_request.downlink_channel_bandwidth);
  CU_ASSERT_EQUAL(in.lte_system_information_schedule_request.downlink_channel_bandwidth,
                  out.lte_system_information_schedule_request.downlink_channel_bandwidth);
  CU_ASSERT_EQUAL(in.lte_system_information_schedule_request.number_of_tx_antenna,
...
void nfapi_test_system_information_schedule_request_nb_iot()
{
  ...
  CU_ASSERT_EQUAL(in.nb_iot_system_information_schedule_request.scheduling_info_sib1_nb,
                  out.nb_iot_system_information_schedule_request.scheduling_info_sib1_nb);
...
void nfapi_test_system_information_request_lte()
{
  ...
  CU_ASSERT_EQUAL(in.lte_system_information_request.downlink_channel_bandwidth,
                  out.lte_system_information_request.downlink_channel_bandwidth);
  CU_ASSERT_EQUAL(in.lte_system_information_request.downlink_channel_bandwidth,
                  out.lte_system_information_request.downlink_channel_bandwidth);
  ...
  CU_ASSERT_EQUAL(in.lte_system_information_request.number_of_si_periodicity,
                  out.lte_system_information_request.number_of_si_periodicity);
  for (idx = 0; idx < in.lte_system_information_request.number_of_si_periodicity; ++idx) {
    CU_ASSERT_EQUAL(in.lte_system_information_request.si_periodicity[idx].si_periodicity,
                    out.lte_system_information_request.si_periodicity[idx].si_periodicity);
    CU_ASSERT_EQUAL(in.lte_system_information_request.si_periodicity[idx].si_index,
                    out.lte_system_information_request.si_periodicity[idx].si_index);
  }
...
void nfapi_test_pnf_param_response()
{
  ...
  for (idx = 0; idx < out.pnf_phy.number_of_phys; ++idx) {
    ...
    for (idx2 = 0; idx2 < out.pnf_phy.phy[idx].number_of_rf_exclusions; ++idx2) {
      CU_ASSERT_EQUAL(in.pnf_phy.phy[idx].excluded_rf_config[idx2].rf_config_index,
                      out.pnf_phy.phy[idx].excluded_rf_config[idx2].rf_config_index);
    }

    CU_ASSERT_EQUAL(in.pnf_phy.phy[idx].downlink_channel_bandwidth_supported,
                    out.pnf_phy.phy[idx].downlink_channel_bandwidth_supported);
    CU_ASSERT_EQUAL(in.pnf_phy.phy[idx].uplink_channel_bandwidth_supported,
                    out.pnf_phy.phy[idx].uplink_channel_bandwidth_supported);
  ...
  for (idx = 0; idx < out.pnf_phy_rel10.number_of_phys; ++idx) {
    ...
    CU_ASSERT_EQUAL(in.pnf_phy_rel10.phy[idx].transmission_mode_7_supported,
                    out.pnf_phy_rel10.phy[idx].transmission_mode_7_supported);
    CU_ASSERT_EQUAL(in.pnf_phy_rel10.phy[idx].transmission_mode_8_supported,
    ...
    CU_ASSERT_EQUAL(in.pnf_phy_rel10.phy[idx].transmission_mode_9_supported,
                    out.pnf_phy_rel10.phy[idx].transmission_mode_9_supported);
    CU_ASSERT_EQUAL(in.pnf_phy_rel10.phy[idx].simultaneous_pucch_pusch, out.pnf_phy_rel10.phy[idx].simultaneous_pucch_pusch);
    CU_ASSERT_EQUAL(in.pnf_phy_rel10.phy[idx].four_layer_tx_with_tm3_and_tm4,
                    out.pnf_phy_rel10.phy[idx].four_layer_tx_with_tm3_and_tm4);
  }
  ...
  for (idx = 0; idx < out.pnf_phy_rel11.number_of_phys; ++idx) {
    ...
    CU_ASSERT_EQUAL(in.pnf_phy_rel11.phy[idx].transmission_mode_5_supported,
                    out.pnf_phy_rel11.phy[idx].transmission_mode_5_supported);
  }
  ...
  for (idx = 0; idx < out.pnf_phy_rel12.number_of_phys; ++idx) {
    ...
    CU_ASSERT_EQUAL(in.pnf_phy_rel12.phy[idx].transmission_mode_10_supported,
  ...
  for (idx = 0; idx < out.pnf_phy_rel13.number_of_phys; ++idx) {
    ...
    CU_ASSERT_EQUAL(in.pnf_phy_rel13.phy[idx].laa_ending_in_dwpts_supported,
                    out.pnf_phy_rel13.phy[idx].laa_ending_in_dwpts_supported);
    CU_ASSERT_EQUAL(in.pnf_phy_rel13.phy[idx].laa_starting_in_second_slot_supported,
    ...
    CU_ASSERT_EQUAL(in.pnf_phy_rel13.phy[idx].csi_rs_enhancement_supported,
                    out.pnf_phy_rel13.phy[idx].csi_rs_enhancement_supported);
  ...
  for (idx = 0; idx < out.pnf_phy_rel13_nb_iot.number_of_phys; ++idx) {
    ...
    for (idx2 = 0; idx2 < out.pnf_phy_rel13_nb_iot.phy[idx].number_of_rfs; ++idx2) {
      CU_ASSERT_EQUAL(in.pnf_phy_rel13_nb_iot.phy[idx].rf_config[idx2].rf_config_index,
                      out.pnf_phy_rel13_nb_iot.phy[idx].rf_config[idx2].rf_config_index);
    }
    CU_ASSERT_EQUAL(in.pnf_phy_rel13_nb_iot.phy[idx].number_of_rf_exclusions,
                    out.pnf_phy_rel13_nb_iot.phy[idx].number_of_rf_exclusions);

    for (idx2 = 0; idx2 < out.pnf_phy_rel13_nb_iot.phy[idx].number_of_rf_exclusions; ++idx2) {
      CU_ASSERT_EQUAL(in.pnf_phy_rel13_nb_iot.phy[idx].excluded_rf_config[idx2].rf_config_index,
                      out.pnf_phy_rel13_nb_iot.phy[idx].excluded_rf_config[idx2].rf_config_index);
    }

    CU_ASSERT_EQUAL(in.pnf_phy_rel13_nb_iot.phy[idx].number_of_dl_layers_supported,
                    out.pnf_phy_rel13_nb_iot.phy[idx].number_of_dl_layers_supported);
    CU_ASSERT_EQUAL(in.pnf_phy_rel13_nb_iot.phy[idx].number_of_ul_layers_supported,
                    out.pnf_phy_rel13_nb_iot.phy[idx].number_of_ul_layers_supported);
    CU_ASSERT_EQUAL(in.pnf_phy_rel13_nb_iot.phy[idx].maximum_3gpp_release_supported,
                    out.pnf_phy_rel13_nb_iot.phy[idx].maximum_3gpp_release_supported);
...
void nfapi_test_pnf_config_request()
{
  ...
  for (idx = 0; idx < out.pnf_phy_rf_config.number_phy_rf_config_info; ++idx) {
    ...
    CU_ASSERT_EQUAL(in.pnf_phy_rf_config.phy_rf_config[idx].phy_config_index,
                    out.pnf_phy_rf_config.phy_rf_config[idx].phy_config_index);
    CU_ASSERT_EQUAL(in.pnf_phy_rf_config.phy_rf_config[idx].rf_config_index,
                    out.pnf_phy_rf_config.phy_rf_config[idx].rf_config_index);
  }
}
...
{
#define SET_TLV(_TLV, _TAG, _VALUE) \
  {                                 \
    _TLV.tl.tag = _TAG;             \
    _TLV.value = _VALUE;            \
    num_tlv++;                      \
  }
#define ASSERT_TLV(IN_TLV, OUT_TLV)                 \
  {                                                 \
    CU_ASSERT_EQUAL(IN_TLV.tl.tag, OUT_TLV.tl.tag); \
    CU_ASSERT_EQUAL(IN_TLV.value, OUT_TLV.value);   \
  }
  ...
  SET_TLV(in.sch_config.primary_synchronization_signal_epre_eprers,
          NFAPI_SCH_CONFIG_PRIMARY_SYNCHRONIZATION_SIGNAL_EPRE_EPRERS_TAG,
          1000);
  SET_TLV(in.sch_config.secondary_synchronization_signal_epre_eprers,
  ...
  SET_TLV(in.srs_config.srs_acknack_srs_simultaneous_transmission,
  ...
  SET_TLV(in.uplink_reference_signal_config.cyclic_shift_1_for_drms,
  ...
  ASSERT_TLV(in.sch_config.secondary_synchronization_signal_epre_eprers,
             out.sch_config.secondary_synchronization_signal_epre_eprers);
  ...
  CU_ASSERT_EQUAL(in.nfapi_config.nmm_gsm_frequency_bands.number_of_rf_bands,
                  out.nfapi_config.nmm_gsm_frequency_bands.number_of_rf_bands);
  ...
  CU_ASSERT_EQUAL(in.nfapi_config.nmm_umts_frequency_bands.number_of_rf_bands,
                  out.nfapi_config.nmm_umts_frequency_bands.number_of_rf_bands);
  ...
  CU_ASSERT_EQUAL(in.nfapi_config.nmm_lte_frequency_bands.number_of_rf_bands,
                  out.nfapi_config.nmm_lte_frequency_bands.number_of_rf_bands);
...
#define ASSERT_TLV(IN_TLV, OUT_TLV)                 \
  ...
  SET_TLV(in.emtc_config.prach_catm_zero_correlation_zone_configuration,
  ...
  SET_TLV(in.emtc_config.prach_ce_level_0_number_of_repetitions_per_attempt,
          NFAPI_EMTC_CONFIG_PRACH_CE_LEVEL_0_NUMBER_OF_REPETITIONS_PER_ATTEMPT_TAG,
          128);
  SET_TLV(in.emtc_config.prach_ce_level_0_starting_subframe_periodicity,
  ...
  SET_TLV(in.emtc_config.prach_ce_level_1_number_of_repetitions_per_attempt,
          NFAPI_EMTC_CONFIG_PRACH_CE_LEVEL_1_NUMBER_OF_REPETITIONS_PER_ATTEMPT_TAG,
          64);
  SET_TLV(in.emtc_config.prach_ce_level_1_starting_subframe_periodicity,
  ...
  SET_TLV(in.emtc_config.prach_ce_level_2_number_of_repetitions_per_attempt,
          NFAPI_EMTC_CONFIG_PRACH_CE_LEVEL_2_NUMBER_OF_REPETITIONS_PER_ATTEMPT_TAG,
          8);
  SET_TLV(in.emtc_config.prach_ce_level_2_starting_subframe_periodicity,
  ...
  SET_TLV(in.emtc_config.prach_ce_level_3_number_of_repetitions_per_attempt,
          NFAPI_EMTC_CONFIG_PRACH_CE_LEVEL_3_NUMBER_OF_REPETITIONS_PER_ATTEMPT_TAG,
          4);
  SET_TLV(in.emtc_config.prach_ce_level_3_starting_subframe_periodicity,
  ...
  SET_TLV(in.emtc_config.pucch_interval_ulhoppingconfigcommonmodea,
          NFAPI_EMTC_CONFIG_PUCCH_INTERVAL_ULHOPPINGCONFIGCOMMONMODEA_TAG,
          8);
  SET_TLV(in.emtc_config.pucch_interval_ulhoppingconfigcommonmodeb,
  ...
  ASSERT_TLV(in.emtc_config.prach_catm_zero_correlation_zone_configuration,
             out.emtc_config.prach_catm_zero_correlation_zone_configuration);
  ...
  ASSERT_TLV(in.emtc_config.prach_ce_level_0_starting_subframe_periodicity,
             out.emtc_config.prach_ce_level_0_starting_subframe_periodicity);
  ...
  ASSERT_TLV(in.emtc_config.prach_ce_level_1_number_of_repetitions_per_attempt,
             out.emtc_config.prach_ce_level_1_number_of_repetitions_per_attempt);
  ASSERT_TLV(in.emtc_config.prach_ce_level_1_starting_subframe_periodicity,
             out.emtc_config.prach_ce_level_1_starting_subframe_periodicity);
  ...
  ASSERT_TLV(in.emtc_config.prach_ce_level_2_number_of_repetitions_per_attempt,
             out.emtc_config.prach_ce_level_2_number_of_repetitions_per_attempt);
  ASSERT_TLV(in.emtc_config.prach_ce_level_2_starting_subframe_periodicity,
  ...
  ASSERT_TLV(in.emtc_config.prach_ce_level_3_number_of_repetitions_per_attempt,
             out.emtc_config.prach_ce_level_3_number_of_repetitions_per_attempt);
  ASSERT_TLV(in.emtc_config.prach_ce_level_3_starting_subframe_periodicity,
...
void nfapi_test_measurement_request()
{
  ...
  //    #define ASSERT_TLV(IN_TLV, OUT_TLV) { CU_ASSERT_EQUAL(IN_TLV.tl.tag, OUT_TLV.tl.tag); CU_ASSERT_EQUAL(IN_TLV.value,
  //    OUT_TLV.value);}
  uint16_t num_tlv = 0;
...
void nfapi_test_measurement_response()
{
  ...
  CU_ASSERT_EQUAL(in.received_interference_power_measurement.number_of_resource_blocks,
                  out.received_interference_power_measurement.number_of_resource_blocks);
  // check array
...
void nfapi_test_dl_config_request()
{
  ...
  in.dl_config_request_body.dl_config_pdu_list =
      (nfapi_dl_config_request_pdu_t*)(malloc(sizeof(nfapi_dl_config_request_pdu_t) * 12));
  ...
  for (idx = 0; idx < in.dl_config_request_body.dl_config_pdu_list[0].dci_dl_pdu.dci_dl_pdu_rel12.number_ul_dl_configurations;
       ++idx) {
  ...
  in.dl_config_request_body.dl_config_pdu_list[7].epdcch_pdu.epdcch_params_rel11.tl.tag =
      NFAPI_DL_CONFIG_REQUEST_EPDCCH_PARAM_REL11_TAG;
  in.dl_config_request_body.dl_config_pdu_list[7].epdcch_pdu.epdcch_params_rel13.tl.tag =
  ...
  in.dl_config_request_body.dl_config_pdu_list[10].npdcch_pdu.npdcch_pdu_rel13.tl.tag =
  ...
  in.dl_config_request_body.dl_config_pdu_list[11].ndlsch_pdu.ndlsch_pdu_rel13.tl.tag =
  ...
  CU_ASSERT_EQUAL(in.dl_config_request_body.dl_config_pdu_list[0].pdu_type,
                  out.dl_config_request_body.dl_config_pdu_list[0].pdu_type);
  CU_ASSERT_EQUAL(in.dl_config_request_body.dl_config_pdu_list[0].pdu_size,
                  out.dl_config_request_body.dl_config_pdu_list[0].pdu_size);
  CU_ASSERT_EQUAL(in.dl_config_request_body.dl_config_pdu_list[0].dci_dl_pdu.dci_dl_pdu_rel8.tl.tag,
                  out.dl_config_request_body.dl_config_pdu_list[0].dci_dl_pdu.dci_dl_pdu_rel8.tl.tag);
  ...
  CU_ASSERT_EQUAL(in.dl_config_request_body.dl_config_pdu_list[0].dci_dl_pdu.dci_dl_pdu_rel9.tl.tag,
                  out.dl_config_request_body.dl_config_pdu_list[0].dci_dl_pdu.dci_dl_pdu_rel9.tl.tag);
  ...
  CU_ASSERT_EQUAL(in.dl_config_request_body.dl_config_pdu_list[0].dci_dl_pdu.dci_dl_pdu_rel10.tl.tag,
                  out.dl_config_request_body.dl_config_pdu_list[0].dci_dl_pdu.dci_dl_pdu_rel10.tl.tag);
  ...
  CU_ASSERT_EQUAL(in.dl_config_request_body.dl_config_pdu_list[0].dci_dl_pdu.dci_dl_pdu_rel11.tl.tag,
                  out.dl_config_request_body.dl_config_pdu_list[0].dci_dl_pdu.dci_dl_pdu_rel11.tl.tag);
  IN_OUT_ASSERT(dl_config_request_body.dl_config_pdu_list[0].dci_dl_pdu.dci_dl_pdu_rel11.harq_ack_resource_offset);
  IN_OUT_ASSERT(
      dl_config_request_body.dl_config_pdu_list[0].dci_dl_pdu.dci_dl_pdu_rel11.pdsch_re_mapping_quasi_co_location_indicator);

  CU_ASSERT_EQUAL(in.dl_config_request_body.dl_config_pdu_list[0].dci_dl_pdu.dci_dl_pdu_rel12.tl.tag,
                  out.dl_config_request_body.dl_config_pdu_list[0].dci_dl_pdu.dci_dl_pdu_rel12.tl.tag);
  ...
  IN_OUT_ASSERT(dl_config_request_body.dl_config_pdu_list[0]
                    .dci_dl_pdu.dci_dl_pdu_rel12.ul_dl_configuration_indication[NFAPI_MAX_UL_DL_CONFIGURATIONS - 1]);

  CU_ASSERT_EQUAL(in.dl_config_request_body.dl_config_pdu_list[0].dci_dl_pdu.dci_dl_pdu_rel13.tl.tag,
                  out.dl_config_request_body.dl_config_pdu_list[0].dci_dl_pdu.dci_dl_pdu_rel13.tl.tag);
  ...
  if (out.dl_config_request_body.dl_config_pdu_list[0].dci_dl_pdu.dci_dl_pdu_rel13.tpm_struct_flag) {
    ...
    uint8_t sb_idx;
    for (sb_idx = 0; sb_idx < out.dl_config_request_body.dl_config_pdu_list[0].dci_dl_pdu.dci_dl_pdu_rel13.tpm.number_of_subbands;
         ++sb_idx) {
      IN_OUT_ASSERT(
          dl_config_request_body.dl_config_pdu_list[0].dci_dl_pdu.dci_dl_pdu_rel13.tpm.subband_info[sb_idx].subband_index);
      IN_OUT_ASSERT(
          dl_config_request_body.dl_config_pdu_list[0].dci_dl_pdu.dci_dl_pdu_rel13.tpm.subband_info[sb_idx].scheduled_ues);

      uint8_t a_idx;
      uint8_t su_idx;

      for (a_idx = 0; a_idx < out.dl_config_request_body.dl_config_pdu_list[0].dci_dl_pdu.dci_dl_pdu_rel13.tpm.num_antennas;
           ++a_idx) {
        for (su_idx = 0;
             su_idx
             < out.dl_config_request_body.dl_config_pdu_list[0].dci_dl_pdu.dci_dl_pdu_rel13.tpm.subband_info[sb_idx].scheduled_ues;
             ++su_idx) {
          IN_OUT_ASSERT(dl_config_request_body.dl_config_pdu_list[0]
                            .dci_dl_pdu.dci_dl_pdu_rel13.tpm.subband_info[sb_idx]
                            .precoding_value[a_idx][su_idx]);
        }
      }
    }
  }
  ...
  IN_OUT_ASSERT(
      dl_config_request_body.dl_config_pdu_list[11].ndlsch_pdu.ndlsch_pdu_rel13.number_of_subframes_for_resource_assignment);
...
void nfapi_test_ul_config_request()
{
  ...
  in.ul_config_request_body.ul_config_pdu_list[16].nulsch_pdu.nulsch_pdu_rel13.tl.tag =
      NFAPI_UL_CONFIG_REQUEST_NULSCH_PDU_REL13_TAG;
  in.ul_config_request_body.ul_config_pdu_list[16].nulsch_pdu.nulsch_pdu_rel13.ue_information.ue_information_rel8.tl.tag =
      NFAPI_UL_CONFIG_REQUEST_UE_INFORMATION_REL8_TAG;
  in.ul_config_request_body.ul_config_pdu_list[16].nulsch_pdu.nulsch_pdu_rel13.ue_information.ue_information_rel11.tl.tag =
      NFAPI_UL_CONFIG_REQUEST_UE_INFORMATION_REL11_TAG;
  in.ul_config_request_body.ul_config_pdu_list[16].nulsch_pdu.nulsch_pdu_rel13.ue_information.ue_information_rel13.tl.tag =
      NFAPI_UL_CONFIG_REQUEST_UE_INFORMATION_REL13_TAG;
  in.ul_config_request_body.ul_config_pdu_list[16]
      .nulsch_pdu.nulsch_pdu_rel13.nb_harq_information.nb_harq_information_rel13_fdd.tl.tag =
      NFAPI_UL_CONFIG_REQUEST_NB_HARQ_INFORMATION_REL13_FDD_TAG;
  in.ul_config_request_body.number_of_pdus++;
  ...
  IN_OUT_ASSERT(
      ul_config_request_body.ul_config_pdu_list[16].nulsch_pdu.nulsch_pdu_rel13.ue_information.ue_information_rel8.tl.tag);
  IN_OUT_ASSERT(
      ul_config_request_body.ul_config_pdu_list[16].nulsch_pdu.nulsch_pdu_rel13.ue_information.ue_information_rel8.handle);
  ...
  IN_OUT_ASSERT(
      ul_config_request_body.ul_config_pdu_list[16].nulsch_pdu.nulsch_pdu_rel13.ue_information.ue_information_rel11.tl.tag);
  IN_OUT_ASSERT(ul_config_request_body.ul_config_pdu_list[16]
                    .nulsch_pdu.nulsch_pdu_rel13.ue_information.ue_information_rel11.virtual_cell_id_enabled_flag);
  IN_OUT_ASSERT(ul_config_request_body.ul_config_pdu_list[16]
                    .nulsch_pdu.nulsch_pdu_rel13.ue_information.ue_information_rel11.npusch_identity);
  IN_OUT_ASSERT(
      ul_config_request_body.ul_config_pdu_list[16].nulsch_pdu.nulsch_pdu_rel13.ue_information.ue_information_rel13.tl.tag);
  IN_OUT_ASSERT(
      ul_config_request_body.ul_config_pdu_list[16].nulsch_pdu.nulsch_pdu_rel13.ue_information.ue_information_rel13.ue_type);
  IN_OUT_ASSERT(
      ul_config_request_body.ul_config_pdu_list[16].nulsch_pdu.nulsch_pdu_rel13.ue_information.ue_information_rel13.empty_symbols);
  IN_OUT_ASSERT(ul_config_request_body.ul_config_pdu_list[16]
                    .nulsch_pdu.nulsch_pdu_rel13.ue_information.ue_information_rel13.total_number_of_repetitions);
  IN_OUT_ASSERT(ul_config_request_body.ul_config_pdu_list[16]
                    .nulsch_pdu.nulsch_pdu_rel13.ue_information.ue_information_rel13.repetition_number);
  IN_OUT_ASSERT(ul_config_request_body.ul_config_pdu_list[16]
                    .nulsch_pdu.nulsch_pdu_rel13.nb_harq_information.nb_harq_information_rel13_fdd.tl.tag);
  IN_OUT_ASSERT(ul_config_request_body.ul_config_pdu_list[16]
                    .nulsch_pdu.nulsch_pdu_rel13.nb_harq_information.nb_harq_information_rel13_fdd.harq_ack_resource);
...
void nfapi_test_hi_dci0_request()
{
  ...
  */
  ...
  in.hi_dci0_request_body.hi_dci0_pdu_list[2].epdcch_dci_pdu.epdcch_dci_pdu_rel8.tl.tag =
      NFAPI_HI_DCI0_REQUEST_EPDCCH_DCI_PDU_REL8_TAG;
  in.hi_dci0_request_body.hi_dci0_pdu_list[2].epdcch_dci_pdu.epdcch_dci_pdu_rel10.tl.tag =
      NFAPI_HI_DCI0_REQUEST_EPDCCH_DCI_PDU_REL10_TAG;
  in.hi_dci0_request_body.hi_dci0_pdu_list[2].epdcch_dci_pdu.epdcch_parameters_rel11.tl.tag =
      NFAPI_HI_DCI0_REQUEST_EPDCCH_PARAMETERS_REL11_TAG;
  /*
  ...
  */
  ...
  in.hi_dci0_request_body.hi_dci0_pdu_list[3].mpdcch_dci_pdu.mpdcch_dci_pdu_rel13.tl.tag =
  ...
  */
  ...
  in.hi_dci0_request_body.hi_dci0_pdu_list[4].npdcch_dci_pdu.npdcch_dci_pdu_rel13.tl.tag =
      NFAPI_HI_DCI0_REQUEST_NPDCCH_DCI_PDU_REL13_TAG;
  in.hi_dci0_request_body.number_of_dci++;
  ...
  CU_ASSERT_EQUAL(in.hi_dci0_request_body.hi_dci0_pdu_list[0].hi_pdu.hi_pdu_rel8.tl.tag,
                  out.hi_dci0_request_body.hi_dci0_pdu_list[0].hi_pdu.hi_pdu_rel8.tl.tag);
  CU_ASSERT_EQUAL(in.hi_dci0_request_body.hi_dci0_pdu_list[0].hi_pdu.hi_pdu_rel10.tl.tag,
                  out.hi_dci0_request_body.hi_dci0_pdu_list[0].hi_pdu.hi_pdu_rel10.tl.tag);

  CU_ASSERT_EQUAL(in.hi_dci0_request_body.hi_dci0_pdu_list[1].pdu_type, out.hi_dci0_request_body.hi_dci0_pdu_list[1].pdu_type);
  CU_ASSERT_EQUAL(in.hi_dci0_request_body.hi_dci0_pdu_list[1].dci_pdu.dci_pdu_rel8.tl.tag,
                  out.hi_dci0_request_body.hi_dci0_pdu_list[1].dci_pdu.dci_pdu_rel8.tl.tag);
  CU_ASSERT_EQUAL(in.hi_dci0_request_body.hi_dci0_pdu_list[1].dci_pdu.dci_pdu_rel10.tl.tag,
                  out.hi_dci0_request_body.hi_dci0_pdu_list[1].dci_pdu.dci_pdu_rel10.tl.tag);
  CU_ASSERT_EQUAL(in.hi_dci0_request_body.hi_dci0_pdu_list[1].dci_pdu.dci_pdu_rel12.tl.tag,
                  out.hi_dci0_request_body.hi_dci0_pdu_list[1].dci_pdu.dci_pdu_rel12.tl.tag);
  ...
  IN_OUT_ASSERT(
      hi_dci0_request_body.hi_dci0_pdu_list[4].npdcch_dci_pdu.npdcch_dci_pdu_rel13.scrambling_reinitialization_batch_index);
...
void nfapi_test_tx_request()
{
  ...
  in.tx_request_body.tx_pdu_list =
      (nfapi_tx_request_pdu_t*)(malloc(sizeof(nfapi_tx_request_pdu_t) * in.tx_request_body.number_of_pdus));
...
void nfapi_test_harq_indication()
{
  ...
  in.harq_indication_body.harq_pdu_list =
      (nfapi_harq_indication_pdu_t*)(calloc(1, sizeof(nfapi_harq_indication_pdu_t) * in.harq_indication_body.number_of_harqs));
  ...
  CU_ASSERT_EQUAL(in.harq_indication_body.harq_pdu_list[0].rx_ue_information.tl.tag,
                  out.harq_indication_body.harq_pdu_list[0].rx_ue_information.tl.tag);
  CU_ASSERT_EQUAL(in.harq_indication_body.harq_pdu_list[0].harq_indication_tdd_rel8.tl.tag,
                  out.harq_indication_body.harq_pdu_list[0].harq_indication_tdd_rel8.tl.tag);
  CU_ASSERT_EQUAL(in.harq_indication_body.harq_pdu_list[1].rx_ue_information.tl.tag,
                  out.harq_indication_body.harq_pdu_list[1].rx_ue_information.tl.tag);
  CU_ASSERT_EQUAL(in.harq_indication_body.harq_pdu_list[1].harq_indication_tdd_rel9.tl.tag,
                  out.harq_indication_body.harq_pdu_list[1].harq_indication_tdd_rel9.tl.tag);
  CU_ASSERT_EQUAL(in.harq_indication_body.harq_pdu_list[2].rx_ue_information.tl.tag,
                  out.harq_indication_body.harq_pdu_list[2].rx_ue_information.tl.tag);
  CU_ASSERT_EQUAL(in.harq_indication_body.harq_pdu_list[2].harq_indication_tdd_rel13.tl.tag,
                  out.harq_indication_body.harq_pdu_list[2].harq_indication_tdd_rel13.tl.tag);
  CU_ASSERT_EQUAL(in.harq_indication_body.harq_pdu_list[3].rx_ue_information.tl.tag,
                  out.harq_indication_body.harq_pdu_list[3].rx_ue_information.tl.tag);
  CU_ASSERT_EQUAL(in.harq_indication_body.harq_pdu_list[3].ul_cqi_information.tl.tag,
                  out.harq_indication_body.harq_pdu_list[3].ul_cqi_information.tl.tag);
  CU_ASSERT_EQUAL(in.harq_indication_body.harq_pdu_list[3].harq_indication_fdd_rel8.tl.tag,
                  out.harq_indication_body.harq_pdu_list[3].harq_indication_fdd_rel8.tl.tag);
  CU_ASSERT_EQUAL(in.harq_indication_body.harq_pdu_list[4].rx_ue_information.tl.tag,
                  out.harq_indication_body.harq_pdu_list[4].rx_ue_information.tl.tag);
  CU_ASSERT_EQUAL(in.harq_indication_body.harq_pdu_list[4].harq_indication_fdd_rel9.tl.tag,
                  out.harq_indication_body.harq_pdu_list[4].harq_indication_fdd_rel9.tl.tag);
  CU_ASSERT_EQUAL(in.harq_indication_body.harq_pdu_list[5].rx_ue_information.tl.tag,
                  out.harq_indication_body.harq_pdu_list[5].rx_ue_information.tl.tag);
  CU_ASSERT_EQUAL(in.harq_indication_body.harq_pdu_list[5].harq_indication_fdd_rel13.tl.tag,
                  out.harq_indication_body.harq_pdu_list[5].harq_indication_fdd_rel13.tl.tag);
...
void nfapi_test_crc_indication()
{
  ...
  in.crc_indication_body.crc_pdu_list =
      (nfapi_crc_indication_pdu_t*)malloc(sizeof(nfapi_crc_indication_pdu_t) * in.crc_indication_body.number_of_crcs);
  ...
  CU_ASSERT_EQUAL(in.crc_indication_body.crc_pdu_list[0].rx_ue_information.tl.tag,
                  out.crc_indication_body.crc_pdu_list[0].rx_ue_information.tl.tag);
  CU_ASSERT_EQUAL(in.crc_indication_body.crc_pdu_list[0].rx_ue_information.handle,
                  out.crc_indication_body.crc_pdu_list[0].rx_ue_information.handle);
  CU_ASSERT_EQUAL(in.crc_indication_body.crc_pdu_list[0].rx_ue_information.rnti,
                  out.crc_indication_body.crc_pdu_list[0].rx_ue_information.rnti);
  CU_ASSERT_EQUAL(in.crc_indication_body.crc_pdu_list[0].crc_indication_rel8.tl.tag,
                  out.crc_indication_body.crc_pdu_list[0].crc_indication_rel8.tl.tag);
  CU_ASSERT_EQUAL(in.crc_indication_body.crc_pdu_list[0].crc_indication_rel8.crc_flag,
                  out.crc_indication_body.crc_pdu_list[0].crc_indication_rel8.crc_flag);

  CU_ASSERT_EQUAL(in.crc_indication_body.crc_pdu_list[1].rx_ue_information.tl.tag,
                  out.crc_indication_body.crc_pdu_list[1].rx_ue_information.tl.tag);
  CU_ASSERT_EQUAL(in.crc_indication_body.crc_pdu_list[1].rx_ue_information.handle,
                  out.crc_indication_body.crc_pdu_list[1].rx_ue_information.handle);
  CU_ASSERT_EQUAL(in.crc_indication_body.crc_pdu_list[1].rx_ue_information.rnti,
                  out.crc_indication_body.crc_pdu_list[1].rx_ue_information.rnti);
  CU_ASSERT_EQUAL(in.crc_indication_body.crc_pdu_list[1].crc_indication_rel8.tl.tag,
                  out.crc_indication_body.crc_pdu_list[1].crc_indication_rel8.tl.tag);
  CU_ASSERT_EQUAL(in.crc_indication_body.crc_pdu_list[1].crc_indication_rel8.crc_flag,
                  out.crc_indication_body.crc_pdu_list[1].crc_indication_rel8.crc_flag);
...
void nfapi_test_rx_ulsch_indication()
{
  ...
  in.rx_indication_body.rx_pdu_list =
      (nfapi_rx_indication_pdu_t*)(calloc(1, sizeof(nfapi_rx_indication_pdu_t) * in.rx_indication_body.number_of_pdus));
  ...
  CU_ASSERT_EQUAL(in.rx_indication_body.rx_pdu_list[0].rx_ue_information.tl.tag,
                  out.rx_indication_body.rx_pdu_list[0].rx_ue_information.tl.tag);
  CU_ASSERT_EQUAL(in.rx_indication_body.rx_pdu_list[0].rx_ue_information.handle,
                  out.rx_indication_body.rx_pdu_list[0].rx_ue_information.handle);
  CU_ASSERT_EQUAL(in.rx_indication_body.rx_pdu_list[0].rx_ue_information.rnti,
                  out.rx_indication_body.rx_pdu_list[0].rx_ue_information.rnti);
  CU_ASSERT_EQUAL(in.rx_indication_body.rx_pdu_list[0].rx_indication_rel8.tl.tag,
                  out.rx_indication_body.rx_pdu_list[0].rx_indication_rel8.tl.tag);
  CU_ASSERT_EQUAL(in.rx_indication_body.rx_pdu_list[0].rx_indication_rel8.length,
                  out.rx_indication_body.rx_pdu_list[0].rx_indication_rel8.length);
  CU_ASSERT_EQUAL(in.rx_indication_body.rx_pdu_list[0].rx_indication_rel8.offset,
                  out.rx_indication_body.rx_pdu_list[0].rx_indication_rel8.offset);
  CU_ASSERT_EQUAL(in.rx_indication_body.rx_pdu_list[0].rx_indication_rel8.ul_cqi,
                  out.rx_indication_body.rx_pdu_list[0].rx_indication_rel8.ul_cqi);
  CU_ASSERT_EQUAL(in.rx_indication_body.rx_pdu_list[0].rx_indication_rel8.timing_advance,
                  out.rx_indication_body.rx_pdu_list[0].rx_indication_rel8.timing_advance);
  CU_ASSERT_EQUAL(in.rx_indication_body.rx_pdu_list[0].rx_indication_rel9.tl.tag,
                  out.rx_indication_body.rx_pdu_list[0].rx_indication_rel9.tl.tag);
  CU_ASSERT_EQUAL(in.rx_indication_body.rx_pdu_list[0].rx_indication_rel9.timing_advance_r9,
                  out.rx_indication_body.rx_pdu_list[0].rx_indication_rel9.timing_advance_r9);
  CU_ASSERT_EQUAL(0, memcmp(in.rx_indication_body.rx_pdu_list[0].data, out.rx_indication_body.rx_pdu_list[0].data, sizeof(pdu1)));

  CU_ASSERT_EQUAL(in.rx_indication_body.rx_pdu_list[1].rx_ue_information.tl.tag,
                  out.rx_indication_body.rx_pdu_list[1].rx_ue_information.tl.tag);
  CU_ASSERT_EQUAL(in.rx_indication_body.rx_pdu_list[1].rx_ue_information.handle,
                  out.rx_indication_body.rx_pdu_list[1].rx_ue_information.handle);
  CU_ASSERT_EQUAL(in.rx_indication_body.rx_pdu_list[1].rx_ue_information.rnti,
                  out.rx_indication_body.rx_pdu_list[1].rx_ue_information.rnti);
  CU_ASSERT_EQUAL(in.rx_indication_body.rx_pdu_list[1].rx_indication_rel8.tl.tag,
                  out.rx_indication_body.rx_pdu_list[1].rx_indication_rel8.tl.tag);
  CU_ASSERT_EQUAL(in.rx_indication_body.rx_pdu_list[1].rx_indication_rel8.length,
                  out.rx_indication_body.rx_pdu_list[1].rx_indication_rel8.length);
  CU_ASSERT_EQUAL(in.rx_indication_body.rx_pdu_list[1].rx_indication_rel8.offset,
                  out.rx_indication_body.rx_pdu_list[1].rx_indication_rel8.offset);
  CU_ASSERT_EQUAL(in.rx_indication_body.rx_pdu_list[1].rx_indication_rel8.ul_cqi,
                  out.rx_indication_body.rx_pdu_list[1].rx_indication_rel8.ul_cqi);
  CU_ASSERT_EQUAL(in.rx_indication_body.rx_pdu_list[1].rx_indication_rel8.timing_advance,
                  out.rx_indication_body.rx_pdu_list[1].rx_indication_rel8.timing_advance);
  CU_ASSERT_EQUAL(in.rx_indication_body.rx_pdu_list[1].data, 0);

  CU_ASSERT_EQUAL(in.rx_indication_body.rx_pdu_list[2].rx_ue_information.tl.tag,
                  out.rx_indication_body.rx_pdu_list[2].rx_ue_information.tl.tag);
  CU_ASSERT_EQUAL(in.rx_indication_body.rx_pdu_list[2].rx_ue_information.handle,
                  out.rx_indication_body.rx_pdu_list[2].rx_ue_information.handle);
  CU_ASSERT_EQUAL(in.rx_indication_body.rx_pdu_list[2].rx_ue_information.rnti,
                  out.rx_indication_body.rx_pdu_list[2].rx_ue_information.rnti);
  CU_ASSERT_EQUAL(in.rx_indication_body.rx_pdu_list[2].rx_indication_rel8.tl.tag,
                  out.rx_indication_body.rx_pdu_list[2].rx_indication_rel8.tl.tag);
  CU_ASSERT_EQUAL(in.rx_indication_body.rx_pdu_list[2].rx_indication_rel8.length,
                  out.rx_indication_body.rx_pdu_list[2].rx_indication_rel8.length);
  CU_ASSERT_EQUAL(in.rx_indication_body.rx_pdu_list[2].rx_indication_rel8.offset,
                  out.rx_indication_body.rx_pdu_list[2].rx_indication_rel8.offset);
  CU_ASSERT_EQUAL(in.rx_indication_body.rx_pdu_list[2].rx_indication_rel8.ul_cqi,
                  in.rx_indication_body.rx_pdu_list[2].rx_indication_rel8.ul_cqi);
  CU_ASSERT_EQUAL(in.rx_indication_body.rx_pdu_list[2].rx_indication_rel8.timing_advance,
                  out.rx_indication_body.rx_pdu_list[2].rx_indication_rel8.timing_advance);
  CU_ASSERT_EQUAL(in.rx_indication_body.rx_pdu_list[2].rx_indication_rel9.tl.tag,
                  out.rx_indication_body.rx_pdu_list[2].rx_indication_rel9.tl.tag);
  CU_ASSERT_EQUAL(in.rx_indication_body.rx_pdu_list[2].rx_indication_rel9.timing_advance_r9,
                  out.rx_indication_body.rx_pdu_list[2].rx_indication_rel9.timing_advance_r9);
...
void nfapi_test_rach_indication()
{
  ...
  in.rach_indication_body.preamble_list =
      (nfapi_preamble_pdu_t*)(malloc(sizeof(nfapi_preamble_pdu_t) * in.rach_indication_body.number_of_preambles));
  ...
  CU_ASSERT_EQUAL(in.rach_indication_body.preamble_list[0].preamble_rel8.tl.tag,
                  out.rach_indication_body.preamble_list[0].preamble_rel8.tl.tag);
  CU_ASSERT_EQUAL(in.rach_indication_body.preamble_list[0].preamble_rel9.tl.tag,
                  out.rach_indication_body.preamble_list[0].preamble_rel9.tl.tag);
  CU_ASSERT_EQUAL(in.rach_indication_body.preamble_list[0].preamble_rel13.tl.tag,
                  out.rach_indication_body.preamble_list[0].preamble_rel13.tl.tag);
  CU_ASSERT_EQUAL(in.rach_indication_body.preamble_list[1].preamble_rel8.tl.tag,
                  out.rach_indication_body.preamble_list[1].preamble_rel8.tl.tag);
  CU_ASSERT_EQUAL(in.rach_indication_body.preamble_list[1].preamble_rel9.tl.tag,
                  out.rach_indication_body.preamble_list[1].preamble_rel9.tl.tag);
  CU_ASSERT_EQUAL(in.rach_indication_body.preamble_list[1].preamble_rel13.tl.tag,
                  out.rach_indication_body.preamble_list[1].preamble_rel13.tl.tag);
...
void nfapi_test_srs_indication()
{
  ...
  in.srs_indication_body.srs_pdu_list =
      (nfapi_srs_indication_pdu_t*)(malloc(sizeof(nfapi_srs_indication_pdu_t) * in.srs_indication_body.number_of_ues));
  ...
  CU_ASSERT_EQUAL(in.srs_indication_body.srs_pdu_list[0].rx_ue_information.tl.tag,
                  out.srs_indication_body.srs_pdu_list[0].rx_ue_information.tl.tag);
  CU_ASSERT_EQUAL(in.srs_indication_body.srs_pdu_list[0].rx_ue_information.handle,
                  out.srs_indication_body.srs_pdu_list[0].rx_ue_information.handle);
  CU_ASSERT_EQUAL(in.srs_indication_body.srs_pdu_list[0].rx_ue_information.rnti,
                  out.srs_indication_body.srs_pdu_list[0].rx_ue_information.rnti);

  CU_ASSERT_EQUAL(in.srs_indication_body.srs_pdu_list[0].srs_indication_fdd_rel8.tl.tag,
                  out.srs_indication_body.srs_pdu_list[0].srs_indication_fdd_rel8.tl.tag);
  CU_ASSERT_EQUAL(in.srs_indication_body.srs_pdu_list[0].srs_indication_fdd_rel8.doppler_estimation,
                  out.srs_indication_body.srs_pdu_list[0].srs_indication_fdd_rel8.doppler_estimation);
  CU_ASSERT_EQUAL(in.srs_indication_body.srs_pdu_list[0].srs_indication_fdd_rel8.timing_advance,
                  out.srs_indication_body.srs_pdu_list[0].srs_indication_fdd_rel8.timing_advance);
  CU_ASSERT_EQUAL(in.srs_indication_body.srs_pdu_list[0].srs_indication_fdd_rel8.number_of_resource_blocks,
                  out.srs_indication_body.srs_pdu_list[0].srs_indication_fdd_rel8.number_of_resource_blocks);
  CU_ASSERT_EQUAL(memcmp(in.srs_indication_body.srs_pdu_list[0].srs_indication_fdd_rel8.snr,
                         out.srs_indication_body.srs_pdu_list[0].srs_indication_fdd_rel8.snr,
                         out.srs_indication_body.srs_pdu_list[0].srs_indication_fdd_rel8.number_of_resource_blocks),
                  0);
  CU_ASSERT_EQUAL(in.srs_indication_body.srs_pdu_list[0].srs_indication_fdd_rel8.rb_start,
                  out.srs_indication_body.srs_pdu_list[0].srs_indication_fdd_rel8.rb_start);

  CU_ASSERT_EQUAL(in.srs_indication_body.srs_pdu_list[0].srs_indication_fdd_rel9.tl.tag,
                  out.srs_indication_body.srs_pdu_list[0].srs_indication_fdd_rel9.tl.tag);
  CU_ASSERT_EQUAL(in.srs_indication_body.srs_pdu_list[0].srs_indication_fdd_rel9.timing_advance_r9,
                  out.srs_indication_body.srs_pdu_list[0].srs_indication_fdd_rel9.timing_advance_r9);
  CU_ASSERT_EQUAL(in.srs_indication_body.srs_pdu_list[0].srs_indication_tdd_rel10.tl.tag,
                  out.srs_indication_body.srs_pdu_list[0].srs_indication_tdd_rel10.tl.tag);
  CU_ASSERT_EQUAL(in.srs_indication_body.srs_pdu_list[0].srs_indication_tdd_rel10.uppts_symbol,
                  out.srs_indication_body.srs_pdu_list[0].srs_indication_tdd_rel10.uppts_symbol);
  CU_ASSERT_EQUAL(in.srs_indication_body.srs_pdu_list[0].srs_indication_fdd_rel11.tl.tag,
                  out.srs_indication_body.srs_pdu_list[0].srs_indication_fdd_rel11.tl.tag);
  CU_ASSERT_EQUAL(in.srs_indication_body.srs_pdu_list[0].srs_indication_fdd_rel11.ul_rtoa,
                  out.srs_indication_body.srs_pdu_list[0].srs_indication_fdd_rel11.ul_rtoa);

  CU_ASSERT_EQUAL(in.srs_indication_body.srs_pdu_list[0].tdd_channel_measurement.tl.tag,
                  out.srs_indication_body.srs_pdu_list[0].tdd_channel_measurement.tl.tag);
  CU_ASSERT_EQUAL(in.srs_indication_body.srs_pdu_list[0].tdd_channel_measurement.num_prb_per_subband,
                  out.srs_indication_body.srs_pdu_list[0].tdd_channel_measurement.num_prb_per_subband);
  CU_ASSERT_EQUAL(in.srs_indication_body.srs_pdu_list[0].tdd_channel_measurement.number_of_subbands,
                  out.srs_indication_body.srs_pdu_list[0].tdd_channel_measurement.number_of_subbands);
  CU_ASSERT_EQUAL(in.srs_indication_body.srs_pdu_list[0].tdd_channel_measurement.num_atennas,
                  out.srs_indication_body.srs_pdu_list[0].tdd_channel_measurement.num_atennas);
  CU_ASSERT_EQUAL(in.srs_indication_body.srs_pdu_list[0].tdd_channel_measurement.subands[0].subband_index,
                  out.srs_indication_body.srs_pdu_list[0].tdd_channel_measurement.subands[0].subband_index)
  CU_ASSERT_EQUAL(in.srs_indication_body.srs_pdu_list[0].tdd_channel_measurement.subands[0].channel[0],
                  out.srs_indication_body.srs_pdu_list[0].tdd_channel_measurement.subands[0].channel[0]);
  CU_ASSERT_EQUAL(in.srs_indication_body.srs_pdu_list[0].tdd_channel_measurement.subands[1].subband_index,
                  out.srs_indication_body.srs_pdu_list[0].tdd_channel_measurement.subands[1].subband_index);
  CU_ASSERT_EQUAL(in.srs_indication_body.srs_pdu_list[0].tdd_channel_measurement.subands[1].channel[0],
                  out.srs_indication_body.srs_pdu_list[0].tdd_channel_measurement.subands[1].channel[0]);

  CU_ASSERT_EQUAL(in.srs_indication_body.srs_pdu_list[1].rx_ue_information.tl.tag,
                  out.srs_indication_body.srs_pdu_list[1].rx_ue_information.tl.tag);
  CU_ASSERT_EQUAL(in.srs_indication_body.srs_pdu_list[1].rx_ue_information.handle,
                  out.srs_indication_body.srs_pdu_list[1].rx_ue_information.handle);
  CU_ASSERT_EQUAL(in.srs_indication_body.srs_pdu_list[1].rx_ue_information.rnti,
                  out.srs_indication_body.srs_pdu_list[1].rx_ue_information.rnti);
...
void nfapi_test_rx_sr_indication()
{
  ...
  in.sr_indication_body.sr_pdu_list =
      (nfapi_sr_indication_pdu_t*)(malloc(sizeof(nfapi_sr_indication_pdu_t) * in.sr_indication_body.number_of_srs));
  ...
  CU_ASSERT_EQUAL(in.sr_indication_body.sr_pdu_list[0].rx_ue_information.tl.tag,
                  out.sr_indication_body.sr_pdu_list[0].rx_ue_information.tl.tag);
  CU_ASSERT_EQUAL(in.sr_indication_body.sr_pdu_list[0].rx_ue_information.handle,
                  out.sr_indication_body.sr_pdu_list[0].rx_ue_information.handle);
  CU_ASSERT_EQUAL(in.sr_indication_body.sr_pdu_list[0].rx_ue_information.rnti,
                  out.sr_indication_body.sr_pdu_list[0].rx_ue_information.rnti);

  CU_ASSERT_EQUAL(in.sr_indication_body.sr_pdu_list[0].ul_cqi_information.tl.tag,
                  out.sr_indication_body.sr_pdu_list[0].ul_cqi_information.tl.tag);
  CU_ASSERT_EQUAL(in.sr_indication_body.sr_pdu_list[0].ul_cqi_information.ul_cqi,
                  out.sr_indication_body.sr_pdu_list[0].ul_cqi_information.ul_cqi);
  CU_ASSERT_EQUAL(in.sr_indication_body.sr_pdu_list[0].ul_cqi_information.channel,
                  out.sr_indication_body.sr_pdu_list[0].ul_cqi_information.channel);

  CU_ASSERT_EQUAL(in.sr_indication_body.sr_pdu_list[1].rx_ue_information.tl.tag,
                  out.sr_indication_body.sr_pdu_list[1].rx_ue_information.tl.tag);
  CU_ASSERT_EQUAL(in.sr_indication_body.sr_pdu_list[1].rx_ue_information.handle,
                  out.sr_indication_body.sr_pdu_list[1].rx_ue_information.handle);
  CU_ASSERT_EQUAL(in.sr_indication_body.sr_pdu_list[1].rx_ue_information.rnti,
                  out.sr_indication_body.sr_pdu_list[1].rx_ue_information.rnti);

  CU_ASSERT_EQUAL(in.sr_indication_body.sr_pdu_list[1].ul_cqi_information.tl.tag,
                  out.sr_indication_body.sr_pdu_list[1].ul_cqi_information.tl.tag);
  CU_ASSERT_EQUAL(in.sr_indication_body.sr_pdu_list[1].ul_cqi_information.ul_cqi,
                  out.sr_indication_body.sr_pdu_list[1].ul_cqi_information.ul_cqi);
  CU_ASSERT_EQUAL(in.sr_indication_body.sr_pdu_list[1].ul_cqi_information.channel,
                  out.sr_indication_body.sr_pdu_list[1].ul_cqi_information.channel);
...
void nfapi_test_rx_cqi_indication()
{
  ...
  in.cqi_indication_body.cqi_pdu_list =
      (nfapi_cqi_indication_pdu_t*)(calloc(1, sizeof(nfapi_cqi_indication_pdu_t) * in.cqi_indication_body.number_of_cqis));
  in.cqi_indication_body.cqi_raw_pdu_list =
      (nfapi_cqi_indication_raw_pdu_t*)(calloc(1, sizeof(nfapi_cqi_indication_raw_pdu_t) * in.cqi_indication_body.number_of_cqis));
  ...
  CU_ASSERT_EQUAL(in.cqi_indication_body.cqi_pdu_list[0].rx_ue_information.tl.tag,
                  out.cqi_indication_body.cqi_pdu_list[0].rx_ue_information.tl.tag);
  CU_ASSERT_EQUAL(in.cqi_indication_body.cqi_pdu_list[0].rx_ue_information.handle,
                  out.cqi_indication_body.cqi_pdu_list[0].rx_ue_information.handle);
  CU_ASSERT_EQUAL(in.cqi_indication_body.cqi_pdu_list[0].rx_ue_information.rnti,
                  out.cqi_indication_body.cqi_pdu_list[0].rx_ue_information.rnti);

  CU_ASSERT_EQUAL(in.cqi_indication_body.cqi_pdu_list[0].cqi_indication_rel8.tl.tag,
                  out.cqi_indication_body.cqi_pdu_list[0].cqi_indication_rel8.tl.tag);
  CU_ASSERT_EQUAL(in.cqi_indication_body.cqi_pdu_list[0].cqi_indication_rel8.length,
                  out.cqi_indication_body.cqi_pdu_list[0].cqi_indication_rel8.length);
  CU_ASSERT_EQUAL(in.cqi_indication_body.cqi_pdu_list[0].cqi_indication_rel8.data_offset,
                  out.cqi_indication_body.cqi_pdu_list[0].cqi_indication_rel8.data_offset);
  CU_ASSERT_EQUAL(in.cqi_indication_body.cqi_pdu_list[0].cqi_indication_rel8.ul_cqi,
                  out.cqi_indication_body.cqi_pdu_list[0].cqi_indication_rel8.ul_cqi);
  CU_ASSERT_EQUAL(in.cqi_indication_body.cqi_pdu_list[0].cqi_indication_rel8.ri,
                  out.cqi_indication_body.cqi_pdu_list[0].cqi_indication_rel8.ri);
  CU_ASSERT_EQUAL(in.cqi_indication_body.cqi_pdu_list[0].cqi_indication_rel8.timing_advance,
                  out.cqi_indication_body.cqi_pdu_list[0].cqi_indication_rel8.timing_advance);
  CU_ASSERT_EQUAL(in.cqi_indication_body.cqi_pdu_list[0].ul_cqi_information.tl.tag,
                  out.cqi_indication_body.cqi_pdu_list[0].ul_cqi_information.tl.tag);
  CU_ASSERT_EQUAL(in.cqi_indication_body.cqi_pdu_list[0].ul_cqi_information.ul_cqi,
                  out.cqi_indication_body.cqi_pdu_list[0].ul_cqi_information.ul_cqi);
  CU_ASSERT_EQUAL(in.cqi_indication_body.cqi_pdu_list[0].ul_cqi_information.channel,
                  out.cqi_indication_body.cqi_pdu_list[0].ul_cqi_information.channel);

  CU_ASSERT_EQUAL(in.cqi_indication_body.cqi_pdu_list[2].rx_ue_information.tl.tag,
                  out.cqi_indication_body.cqi_pdu_list[2].rx_ue_information.tl.tag);
  CU_ASSERT_EQUAL(in.cqi_indication_body.cqi_pdu_list[2].rx_ue_information.handle,
                  out.cqi_indication_body.cqi_pdu_list[2].rx_ue_information.handle);
  CU_ASSERT_EQUAL(in.cqi_indication_body.cqi_pdu_list[2].rx_ue_information.rnti,
                  out.cqi_indication_body.cqi_pdu_list[2].rx_ue_information.rnti);
  CU_ASSERT_EQUAL(in.cqi_indication_body.cqi_pdu_list[2].cqi_indication_rel9.tl.tag,
                  out.cqi_indication_body.cqi_pdu_list[2].cqi_indication_rel9.tl.tag);
  CU_ASSERT_EQUAL(in.cqi_indication_body.cqi_pdu_list[2].cqi_indication_rel9.length,
                  out.cqi_indication_body.cqi_pdu_list[2].cqi_indication_rel9.length);
  CU_ASSERT_EQUAL(in.cqi_indication_body.cqi_pdu_list[2].cqi_indication_rel9.data_offset,
                  out.cqi_indication_body.cqi_pdu_list[2].cqi_indication_rel9.data_offset);
  CU_ASSERT_EQUAL(in.cqi_indication_body.cqi_pdu_list[2].cqi_indication_rel9.ul_cqi,
                  out.cqi_indication_body.cqi_pdu_list[2].cqi_indication_rel9.ul_cqi);
  CU_ASSERT_EQUAL(in.cqi_indication_body.cqi_pdu_list[2].cqi_indication_rel9.number_of_cc_reported,
                  out.cqi_indication_body.cqi_pdu_list[2].cqi_indication_rel9.number_of_cc_reported);
  CU_ASSERT_EQUAL(in.cqi_indication_body.cqi_pdu_list[2].cqi_indication_rel9.ri[0],
                  out.cqi_indication_body.cqi_pdu_list[2].cqi_indication_rel9.ri[0]);
  CU_ASSERT_EQUAL(in.cqi_indication_body.cqi_pdu_list[2].cqi_indication_rel9.ri[1],
                  out.cqi_indication_body.cqi_pdu_list[2].cqi_indication_rel9.ri[1]);
  CU_ASSERT_EQUAL(in.cqi_indication_body.cqi_pdu_list[2].cqi_indication_rel9.ri[2],
                  out.cqi_indication_body.cqi_pdu_list[2].cqi_indication_rel9.ri[2]);
  CU_ASSERT_EQUAL(in.cqi_indication_body.cqi_pdu_list[2].cqi_indication_rel9.ri[3],
                  out.cqi_indication_body.cqi_pdu_list[2].cqi_indication_rel9.ri[3]);
  CU_ASSERT_EQUAL(in.cqi_indication_body.cqi_pdu_list[2].cqi_indication_rel9.timing_advance,
                  out.cqi_indication_body.cqi_pdu_list[2].cqi_indication_rel9.timing_advance);
  CU_ASSERT_EQUAL(in.cqi_indication_body.cqi_pdu_list[2].ul_cqi_information.tl.tag,
                  out.cqi_indication_body.cqi_pdu_list[2].ul_cqi_information.tl.tag);
  CU_ASSERT_EQUAL(in.cqi_indication_body.cqi_pdu_list[2].ul_cqi_information.ul_cqi,
                  out.cqi_indication_body.cqi_pdu_list[2].ul_cqi_information.ul_cqi);
  CU_ASSERT_EQUAL(in.cqi_indication_body.cqi_pdu_list[2].ul_cqi_information.channel,
                  out.cqi_indication_body.cqi_pdu_list[2].ul_cqi_information.channel);

  CU_ASSERT_EQUAL(
      memcmp(in.cqi_indication_body.cqi_raw_pdu_list[0].pdu, out.cqi_indication_body.cqi_raw_pdu_list[0].pdu, sizeof(cqi_1)),
      0);
  CU_ASSERT_EQUAL(
      memcmp(in.cqi_indication_body.cqi_raw_pdu_list[2].pdu, out.cqi_indication_body.cqi_raw_pdu_list[2].pdu, sizeof(cqi_2)),
      0);
...
void nfapi_test_lbt_dl_config_request()
{
  ...
  in.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list = (nfapi_lbt_dl_config_request_pdu_t*)(malloc(
      sizeof(nfapi_lbt_dl_config_request_pdu_t) * in.lbt_dl_config_request_body.number_of_pdus));
  ...
  in.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[0].lbt_pdsch_req_pdu.lbt_pdsch_req_pdu_rel13.tl.tag =
      NFAPI_LBT_PDSCH_REQ_PDU_REL13_TAG;
  ...
  in.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[1].lbt_drs_req_pdu.lbt_drs_req_pdu_rel13.tl.tag =
  ...
  CU_ASSERT_EQUAL(in.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[0].pdu_type,
                  out.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[0].pdu_type);
  CU_ASSERT_EQUAL(in.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[0].pdu_size,
                  out.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[0].pdu_size);
  CU_ASSERT_EQUAL(in.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[0].lbt_pdsch_req_pdu.lbt_pdsch_req_pdu_rel13.tl.tag,
                  out.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[0].lbt_pdsch_req_pdu.lbt_pdsch_req_pdu_rel13.tl.tag);
  CU_ASSERT_EQUAL(in.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[0].lbt_pdsch_req_pdu.lbt_pdsch_req_pdu_rel13.handle,
                  out.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[0].lbt_pdsch_req_pdu.lbt_pdsch_req_pdu_rel13.handle);
  CU_ASSERT_EQUAL(in.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[0].lbt_pdsch_req_pdu.lbt_pdsch_req_pdu_rel13.mp_cca,
                  out.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[0].lbt_pdsch_req_pdu.lbt_pdsch_req_pdu_rel13.mp_cca);
  CU_ASSERT_EQUAL(in.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[0].lbt_pdsch_req_pdu.lbt_pdsch_req_pdu_rel13.n_cca,
                  out.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[0].lbt_pdsch_req_pdu.lbt_pdsch_req_pdu_rel13.n_cca);
  CU_ASSERT_EQUAL(in.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[0].lbt_pdsch_req_pdu.lbt_pdsch_req_pdu_rel13.offset,
                  out.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[0].lbt_pdsch_req_pdu.lbt_pdsch_req_pdu_rel13.offset);
  CU_ASSERT_EQUAL(
      in.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[0].lbt_pdsch_req_pdu.lbt_pdsch_req_pdu_rel13.lte_txop_sf,
      out.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[0].lbt_pdsch_req_pdu.lbt_pdsch_req_pdu_rel13.lte_txop_sf);
  CU_ASSERT_EQUAL(
      in.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[0].lbt_pdsch_req_pdu.lbt_pdsch_req_pdu_rel13.txop_sfn_sf_end,
      out.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[0].lbt_pdsch_req_pdu.lbt_pdsch_req_pdu_rel13.txop_sfn_sf_end);
  CU_ASSERT_EQUAL(in.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[0].lbt_pdsch_req_pdu.lbt_pdsch_req_pdu_rel13.lbt_mode,
                  out.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[0].lbt_pdsch_req_pdu.lbt_pdsch_req_pdu_rel13.lbt_mode);

  CU_ASSERT_EQUAL(in.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[1].pdu_type,
                  out.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[1].pdu_type);
  CU_ASSERT_EQUAL(in.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[1].pdu_size,
                  out.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[1].pdu_size);
  CU_ASSERT_EQUAL(in.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[1].lbt_drs_req_pdu.lbt_drs_req_pdu_rel13.tl.tag,
                  out.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[1].lbt_drs_req_pdu.lbt_drs_req_pdu_rel13.tl.tag);
  CU_ASSERT_EQUAL(in.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[1].lbt_drs_req_pdu.lbt_drs_req_pdu_rel13.handle,
                  out.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[1].lbt_drs_req_pdu.lbt_drs_req_pdu_rel13.handle);
  CU_ASSERT_EQUAL(in.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[1].lbt_drs_req_pdu.lbt_drs_req_pdu_rel13.offset,
                  out.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[1].lbt_drs_req_pdu.lbt_drs_req_pdu_rel13.offset);
  CU_ASSERT_EQUAL(in.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[1].lbt_drs_req_pdu.lbt_drs_req_pdu_rel13.sfn_sf_end,
                  out.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[1].lbt_drs_req_pdu.lbt_drs_req_pdu_rel13.sfn_sf_end);
  CU_ASSERT_EQUAL(in.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[1].lbt_drs_req_pdu.lbt_drs_req_pdu_rel13.lbt_mode,
                  out.lbt_dl_config_request_body.lbt_dl_config_req_pdu_list[1].lbt_drs_req_pdu.lbt_drs_req_pdu_rel13.lbt_mode);
...
void nfapi_test_lbt_dl_indication()
{
  ...
  in.lbt_dl_indication_body.lbt_indication_pdu_list =
      (nfapi_lbt_dl_indication_pdu_t*)(malloc(sizeof(nfapi_lbt_dl_indication_pdu_t) * in.lbt_dl_indication_body.number_of_pdus));
  ...
  in.lbt_dl_indication_body.lbt_indication_pdu_list[0].lbt_pdsch_rsp_pdu.lbt_pdsch_rsp_pdu_rel13.tl.tag =
      NFAPI_LBT_PDSCH_RSP_PDU_REL13_TAG;
  ...
  in.lbt_dl_indication_body.lbt_indication_pdu_list[1].lbt_drs_rsp_pdu.lbt_drs_rsp_pdu_rel13.tl.tag =
      NFAPI_LBT_DRS_RSP_PDU_REL13_TAG;
  ...
  CU_ASSERT_EQUAL(in.lbt_dl_indication_body.lbt_indication_pdu_list[0].pdu_type,
                  out.lbt_dl_indication_body.lbt_indication_pdu_list[0].pdu_type);
  CU_ASSERT_EQUAL(in.lbt_dl_indication_body.lbt_indication_pdu_list[0].pdu_size,
                  out.lbt_dl_indication_body.lbt_indication_pdu_list[0].pdu_size);
  CU_ASSERT_EQUAL(in.lbt_dl_indication_body.lbt_indication_pdu_list[0].lbt_pdsch_rsp_pdu.lbt_pdsch_rsp_pdu_rel13.tl.tag,
                  out.lbt_dl_indication_body.lbt_indication_pdu_list[0].lbt_pdsch_rsp_pdu.lbt_pdsch_rsp_pdu_rel13.tl.tag);
  CU_ASSERT_EQUAL(in.lbt_dl_indication_body.lbt_indication_pdu_list[0].lbt_pdsch_rsp_pdu.lbt_pdsch_rsp_pdu_rel13.handle,
                  out.lbt_dl_indication_body.lbt_indication_pdu_list[0].lbt_pdsch_rsp_pdu.lbt_pdsch_rsp_pdu_rel13.handle);
  CU_ASSERT_EQUAL(in.lbt_dl_indication_body.lbt_indication_pdu_list[0].lbt_pdsch_rsp_pdu.lbt_pdsch_rsp_pdu_rel13.result,
                  out.lbt_dl_indication_body.lbt_indication_pdu_list[0].lbt_pdsch_rsp_pdu.lbt_pdsch_rsp_pdu_rel13.result);
  CU_ASSERT_EQUAL(in.lbt_dl_indication_body.lbt_indication_pdu_list[0].lbt_pdsch_rsp_pdu.lbt_pdsch_rsp_pdu_rel13.lte_txop_symbols,
                  out.lbt_dl_indication_body.lbt_indication_pdu_list[0].lbt_pdsch_rsp_pdu.lbt_pdsch_rsp_pdu_rel13.lte_txop_symbols);
  CU_ASSERT_EQUAL(
      in.lbt_dl_indication_body.lbt_indication_pdu_list[0].lbt_pdsch_rsp_pdu.lbt_pdsch_rsp_pdu_rel13.initial_partial_sf,
      out.lbt_dl_indication_body.lbt_indication_pdu_list[0].lbt_pdsch_rsp_pdu.lbt_pdsch_rsp_pdu_rel13.initial_partial_sf);

  CU_ASSERT_EQUAL(in.lbt_dl_indication_body.lbt_indication_pdu_list[1].pdu_type,
                  out.lbt_dl_indication_body.lbt_indication_pdu_list[1].pdu_type);
  CU_ASSERT_EQUAL(in.lbt_dl_indication_body.lbt_indication_pdu_list[1].pdu_size,
                  out.lbt_dl_indication_body.lbt_indication_pdu_list[1].pdu_size);

  CU_ASSERT_EQUAL(in.lbt_dl_indication_body.lbt_indication_pdu_list[1].lbt_drs_rsp_pdu.lbt_drs_rsp_pdu_rel13.tl.tag,
                  out.lbt_dl_indication_body.lbt_indication_pdu_list[1].lbt_drs_rsp_pdu.lbt_drs_rsp_pdu_rel13.tl.tag);
  CU_ASSERT_EQUAL(in.lbt_dl_indication_body.lbt_indication_pdu_list[1].lbt_drs_rsp_pdu.lbt_drs_rsp_pdu_rel13.handle,
                  out.lbt_dl_indication_body.lbt_indication_pdu_list[1].lbt_drs_rsp_pdu.lbt_drs_rsp_pdu_rel13.handle);
  CU_ASSERT_EQUAL(in.lbt_dl_indication_body.lbt_indication_pdu_list[1].lbt_drs_rsp_pdu.lbt_drs_rsp_pdu_rel13.result,
                  out.lbt_dl_indication_body.lbt_indication_pdu_list[1].lbt_drs_rsp_pdu.lbt_drs_rsp_pdu_rel13.result);
...
int main ( int argc, char** argv)
{
  ...
  if (pSuiteP4) {
    if ((NULL == CU_add_test(pSuiteP4, "nfapi_test_rssi_request_lte", nfapi_test_rssi_request_lte))
        ...
        || (NULL
            == CU_add_test(pSuiteP4,
                           "nfapi_test_rssi_request_lte_rat_type_mismatch",
                           nfapi_test_rssi_request_lte_rat_type_mismatch))
        ...
        || (NULL
            == CU_add_test(pSuiteP4, "nfapi_test_cell_search_request_utran_overrun", nfapi_test_cell_search_request_utran_overrun))
        || (NULL == CU_add_test(pSuiteP4, "nfapi_test_cell_search_request_geran", nfapi_test_cell_search_request_geran))
        || (NULL
            == CU_add_test(pSuiteP4, "nfapi_test_cell_search_request_geran_overrun", nfapi_test_cell_search_request_geran_overrun))
        ...
        || (NULL
            == CU_add_test(pSuiteP4,
                           "nfapi_test_broadcast_detect_request_state_overrun",
                           nfapi_test_broadcast_detect_request_state_overrun))
        ...
        || (NULL
            == CU_add_test(pSuiteP4,
                           "nfapi_test_broadcast_detect_indication_lte_overrun",
                           nfapi_test_broadcast_detect_indication_lte_overrun))
        || (NULL
            == CU_add_test(pSuiteP4, "nfapi_test_broadcast_detect_indication_utran", nfapi_test_broadcast_detect_indication_utran))
        || (NULL
            == CU_add_test(pSuiteP4,
                           "nfapi_test_broadcast_detect_indication_utran_overrun",
                           nfapi_test_broadcast_detect_indication_utran_overrun))
        || (NULL
            == CU_add_test(pSuiteP4,
                           "nfapi_test_broadcast_detect_indication_state_overrun",
                           nfapi_test_broadcast_detect_indication_state_overrun))
        || (NULL
            == CU_add_test(pSuiteP4,
        ...
        || (NULL
            == CU_add_test(pSuiteP4,
                           "nfapi_test_system_information_schedule_request_lte",
                           nfapi_test_system_information_schedule_request_lte))
        || (NULL
            == CU_add_test(pSuiteP4,
                           "nfapi_test_system_information_schedule_request_state_overrun",
                           nfapi_test_system_information_schedule_request_state_overrun))
        || (NULL
            == CU_add_test(pSuiteP4,
                           "nfapi_test_system_information_schedule_request_nb_iot",
                           nfapi_test_system_information_schedule_request_nb_iot))
        || (NULL
            == CU_add_test(pSuiteP4,
        ...
        || (NULL
            == CU_add_test(pSuiteP4,
                           "nfapi_test_system_information_schedule_indication_lte",
                           nfapi_test_system_information_schedule_indication_lte))
        || (NULL
            == CU_add_test(pSuiteP4,
        ...
        || (NULL
            == CU_add_test(pSuiteP4,
                           "nfapi_test_system_information_request_lte_overrun",
                           nfapi_test_system_information_request_lte_overrun))
        || (NULL
            == CU_add_test(pSuiteP4, "nfapi_test_system_information_request_utran", nfapi_test_system_information_request_utran))
        || (NULL
            == CU_add_test(pSuiteP4, "nfapi_test_system_information_request_geran", nfapi_test_system_information_request_geran))
        || (NULL
            == CU_add_test(pSuiteP4,
                           "nfapi_test_system_information_request_state_overrun",
                           nfapi_test_system_information_request_state_overrun))
        || (NULL
            == CU_add_test(pSuiteP4, "nfapi_test_system_information_request_nb_iot", nfapi_test_system_information_request_nb_iot))
        || (NULL == CU_add_test(pSuiteP4, "nfapi_test_system_information_response", nfapi_test_system_information_response))
        || (NULL
            == CU_add_test(pSuiteP4, "nfapi_test_system_information_indication_lte", nfapi_test_system_information_indication_lte))
        || (NULL
            == CU_add_test(pSuiteP4,
        ...
        || (NULL
            == CU_add_test(pSuiteP4,
                           "nfapi_test_system_information_indication_utran",
                           nfapi_test_system_information_indication_utran))
        || (NULL
            == CU_add_test(pSuiteP4,
                           "nfapi_test_system_information_indication_utran_overrun",
                           nfapi_test_system_information_indication_utran_overrun))
        || (NULL
            == CU_add_test(pSuiteP4,
                           "nfapi_test_system_information_indication_geran",
                           nfapi_test_system_information_indication_geran))
        || (NULL
            == CU_add_test(pSuiteP4,
                           "nfapi_test_system_information_indication_geran_overrun",
                           nfapi_test_system_information_indication_geran_overrun))
        || (NULL
            == CU_add_test(pSuiteP4,
                           "nfapi_test_system_information_indication_nb_iot",
                           nfapi_test_system_information_indication_nb_iot))
  ...
  if (pSuiteP7) {
    if ((NULL == CU_add_test(pSuiteP7, "nfapi_test_dl_config_request", nfapi_test_dl_config_request))
        ...
        || (NULL
            == CU_add_test(pSuiteP7,
                           "nfapi_test_lbt_dl_indication_invalid_pdu_type",
                           nfapi_test_lbt_dl_indication_invalid_pdu_type))
