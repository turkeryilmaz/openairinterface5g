 ...
 */
/*! \file nfapi/tests/p7/nr_fapi_uci_indication_test.c
 * \brief
...
static size_t get_uci_indication_size(nfapi_nr_uci_indication_t *msg)
{
  ...
  for (int uci_idx = 0; uci_idx < msg->num_ucis; ++uci_idx) {
    nfapi_nr_uci_t *uci_pdu = &msg->uci_list[uci_idx];
