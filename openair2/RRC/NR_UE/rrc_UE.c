...
NR_UE_RRC_INST_t* get_NR_UE_rrc_inst(int instance)
{
  ...
  AssertFatal(instance < MAX_NUM_NR_UE_INST, "RRC instance %d out of bounds\n", instance);
  AssertFatal(rrc != NULL, "RRC instance %d not initialized\n", instance);
...
NR_UE_RRC_INST_t* nr_rrc_init_ue(char* uecap_file, int instance_id, int num_ant_tx)
{
  ...
  NR_UE_rrc_inst[instance_id] = (NR_UE_RRC_INST_t *)calloc_or_fail(1, sizeof(NR_UE_RRC_INST_t));
