...
void process_msg_rcc_to_mac(MessageDef *msg)
{
  ...
  switch (ITTI_MSG_ID(msg)) {
    ...
    case NR_MAC_RRC_CONFIG_MIB:
      nr_rrc_mac_config_req_mib(ue_id, 0, NR_MAC_RRC_CONFIG_MIB(msg).bcch->message.choice.mib, NR_MAC_RRC_CONFIG_MIB(msg).arfcn_ssb, NR_MAC_RRC_CONFIG_MIB(msg).get_sib);
    ...
    case NR_MAC_RRC_CONFIG_SIB1: {
      ...
      nr_rrc_mac_config_req_sib1(ue_id, 0, sib1, NR_MAC_RRC_CONFIG_SIB1(msg).arfcn_ssb);
