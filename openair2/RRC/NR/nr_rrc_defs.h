...
typedef struct HANDOVER_INFO_NR_s {
  ...
  // AS_Config_t                                       as_config;          /* these two parameters are taken from 36.331
  // section 10.2.2: HandoverPreparationInformation-r8-IEs */ AS_Context_t                                      as_context; /* They
  // are mandatory for HO */
