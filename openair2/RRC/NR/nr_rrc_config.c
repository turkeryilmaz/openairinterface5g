...
for (int k=k2+1;k<k2+5;k++){
  ...
  *pusch_timedomainresourceallocation3->k2 = k;
  pusch_timedomainresourceallocation3->mappingType = NR_PUSCH_TimeDomainResourceAllocation__mappingType_typeB;
  pusch_timedomainresourceallocation3->startSymbolAndLength = get_SLIV(0,13); // basic slot configuration starting in symbol 0 til the last but one symbol
