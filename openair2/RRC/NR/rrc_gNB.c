    ...
    switch (ITTI_MSG_ID(msg_p)) {
      ...
      case SS_NRRRC_PDU_REQ:
        ...
        if ((SS_NRRRC_PDU_REQ(msg_p).srb_id) != 0)
        {
          ...
          nr_pdcp_data_req_srb(ctxt.rntiMaybeUEid, SS_NRRRC_PDU_REQ (msg_p).srb_id, rrc_gNB_mui++, SS_NRRRC_PDU_REQ (msg_p).sdu_size, SS_NRRRC_PDU_REQ (msg_p).sdu, deliver_pdu_srb_f1, RC.nrrrc[ctxt.module_id]);
