                 ...
                 int do_drb_ciphering)
{
  ...
  if (est_drb->status == DRB_INACTIVE) {
    ...
    est_drb->pdcp_config.t_Reordering = get_softmodem_params()->ntn_trd; // this will just provide the index of the enum (old value: NR_PDCP_Config__t_Reordering_ms15;)
