...
rb_found:
  ...
  ctx.rnti = ue->rnti;
  ctx.frame = RC.ss.ss_cell_list[0].mac_rlc_data_ind_frame; /* Populating the frame received from Lower layer */
   ctx.subframe = RC.ss.ss_cell_list[0].mac_rlc_data_ind_subframe; /* Populating the subframe received from Lower layer */
