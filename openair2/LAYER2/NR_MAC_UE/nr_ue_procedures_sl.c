...
static void handle_nr_ue_sl_harq(module_id_t mod_id, frame_t frame, sub_frame_t slot, sl_nr_slsch_pdu_t *rx_slsch_pdu, uint16_t src_id);
...
static void handle_nr_ue_sl_harq(module_id_t mod_id,
                          frame_t frame,
                          sub_frame_t slot,
