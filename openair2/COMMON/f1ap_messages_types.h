...
//   F1AP_RequestedSRSTransmissionCharacteristics_t req_SRS_info;
//   Requested_SRS_Transmission_Characteristics // IE 9.3.1.175 (O) //NRPPA_RequestedSRSTransmissionCharacteristics_t req_SRS_info;
...
typedef struct f1ap_positioning_information_resp_s
{
    ...
    nrppa_f1ap_info_t nrppa_msg_info;
//  NR_SRS_Config_t
//   SRS_Configuration // IE 9.3.1.192 (O) //NR_SRS_Config_t *srs_config
//   SFN Initialisation Time // IE 9.3.1.183 (0)
//  Criticality_Diagnostics // IE 9.3.1.3 (O)
