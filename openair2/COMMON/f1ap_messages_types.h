...
/*NRPPA IE*/  // adeel
/* IE structures for Positioning related messages */
...
typedef enum f1ap_type_of_error_t{
  F1AP_NOT_UNDERSTOOD = 0,
  F1AP_MISSING = 1
}f1ap_type_of_error_t;
...
typedef enum f1ap_transmission_comb_pr{
...
typedef	struct f1ap_resource_type_periodic_s{
    uint8_t	 periodicity; //slot1= 0, slot2= 1, slot4= 2, slot5= 3, slot8= 4, slot10= 5, slot16= 6, slot20= 7, slot32= 8, slot40= 9, slot64= 10, slot80= 11,slot160= 12, slot320= 13,slot640= 14, slot1280= 15, slot2560= 16
	uint16_t offset;
...
typedef enum f1ap_resource_type_pr{
...
typedef union f1ap_transmission_comb_pos_c {
    ...
    f1ap_transmission_comb_pos_n2_t n4;
...
typedef struct f1ap_resource_type_periodic_pos_s{
	uint16_t	 periodicity; //slot1= 0, slot2= 1, slot4= 2, slot5= 3, slot8= 4, slot10= 5, slot16= 6, slot20= 7, slot32= 8, slot40= 9, slot64= 10, slot80= 11,slot160= 12, slot320= 13,slot640= 14, slot1280= 15, slot2560= 16, slot5120= 17, slot10240= 18, slot20480= 19, slot40960= 20, slot81920= 21
	uint16_t     offset;
...
typedef enum f1ap_resource_set_type_pr{
...
typedef struct f1ap_pos_srs_resource_item_s{
	...
	f1ap_transmission_comb_pos_u	 transmissionCombPos; // (M)
	uint8_t	                         startPosition; // (M)  range (0,1,...13)
	uint8_t	                         nrofSymbols; // (M)  n1	= 0, n2	= 1, n4	= 2, n8	= 3, n12 = 4
	uint16_t	                     freqDomainShift; // (M)
	uint8_t	                         c_SRS; // (M)
	uint8_t	                         groupOrSequenceHopping; // (M)  neither	= 0, groupHopping	= 1, sequenceHopping	= 2
	f1ap_resource_type_pos_u	     resourceTypePos; // (M)
...
typedef struct f1ap_pos_srs_resource_set_item_s{
	...
	f1ap_pos_resource_set_type_u	 posresourceSetType;   // F1AP_PosResourceSetType_t	 posresourceSetType;
...
uint8_t 	periodicitySRS; //milli seconds(ms) 0.125= 0, 0.25=1, 0.5=2,0.625=3,1=4,1.25=5,2=6,2.5=7,4=8,5=9,8=10,ms10=11,ms16=12,20=13,32=14,40=15,64=16,80=17,160=18,320=19,640=20,1280= 21,2560=22,5120=23,10240=24
...
typedef struct f1ap_requested_SRS_transmission_characteristics_s{
    uint16_t                        numberOfTransmissions; // (O) no of periodic transmission, 0= infinite no of SRS transmission, Applicable only if Resource type IE is periodic
    uint8_t	                        resourceType; // (M)
    bandwidth_srs_u                 bandwidth_srs;  // (M)
...
typedef struct f1ap_trp_information_type_item_s{
    uint8_t   TRPInformationTypeItem; // nrPCI	= 0, nG_RAN_CGI	= 1, arfcn= 2, pRSConfig= 3, sSBConfig= 4, sFNInitTime= 5, spatialDirectInfo= 6, geoCoord= 7
...
typedef struct f1ap_additional_path_list_s{ //IE 9.3.1.169 TS 38.473 V16.3.1 //A_SEQUENCE_OF(struct F1AP_AdditionalPath_Item) list;
...
typedef union f1ap_ul_rtoa_measurement_s{ //IE 9.3.1.168 TS 38.473 V16.3.1
	f1ap_ul_rtoa_measurement_item_u	 uL_RTOA_MeasurementItem;
...
typedef struct f1ap_gnb_rx_tx_time_diff_s{ //IE 9.3.1.170 TS 38.473 V16.3.1
    f1ap_gnb_rx_tx_time_diff_meas_u	    rxTxTimeDiff;
	f1ap_additional_path_list_t	        additionalPath_List;	// OPTIONAL
...
typedef struct f1ap_time_stamp_s{  //IE 9.3.1.171 TS 38.473 V16.3.1
	...
	f1ap_time_stamp_slot_index_u	 slotIndex;
...
typedef union f1ap_pos_measurement_result_item_c{
    f1ap_measured_results_value_u	    measuredResultsValue;
...
}f1ap_pos_measurement_result_item_u;

typedef struct f1ap_pos_measurement_result_s{ //IE 9.3.1.166 TS 38.473 V16.3.1//A_SEQUENCE_OF(struct F1AP_PosMeasurementResultItem) list;
    f1ap_pos_measurement_result_item_u *pos_measurement_result_item;
...
typedef struct f1ap_positioning_activation_req_s{
    ...
    uint32_t            gNB_DU_ue_id;  // IE 9.3.1.5 (M)
    nrppa_f1ap_info_t   nrppa_msg_info;
    f1ap_srs_type_u     srs_type;
    bit_string_t        sfn_initialisation_time;
...
typedef struct f1ap_positioning_deactivation_s{
    ...
    uint32_t                    gNB_DU_ue_id;  // IE 9.3.1.5 (M)
    nrppa_f1ap_info_t           nrppa_msg_info;
    f1ap_abort_transmission_u   abort_transmission;
...
typedef struct f1ap_measurement_req_s{
    ...
    uint8_t                             pos_measurement_periodicity; //(C) if report characteristics periodic	ms120=0, ms240=1, ms480=2, ms640=3, ms1024=4, ms2048	=5, ms5120=6, ms10240=7, min1=8, min6= 9,min12= 10,min30= 11,min60= 12
