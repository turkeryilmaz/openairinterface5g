  ...
  for(i=0; i < m2ap_mbms_scheduling_information->num_mbms_area_config_list; i++){ 
      ...
      for(j=0; j < m2ap_mbms_scheduling_information->mbms_area_config_list[i].num_pmch_config_list; j++){
        ...
        pmch_configuration_item = &pmch_configuration_item_ies->value.choice.PMCH_Configuration_Item;
        {
          ...
          for (k = 0; k < m2ap_mbms_scheduling_information->mbms_area_config_list[i].pmch_config_list[j].num_mbms_session_list;
               k++) {
        ...
        mbsfn_subframe_configuration = &mbsfn_subframe_configuration_item_ies->value.choice.MBSFN_Subframe_Configuration;
        {
          ...
          if (m2ap_mbms_scheduling_information->mbms_area_config_list[i].mbms_sf_config_list[j].is_four_sf) {
            ...
            mbsfn_subframe_configuration->subframeAllocation.choice.oneFrame.buf[1] =
                ((m2ap_mbms_scheduling_information->mbms_area_config_list[i].mbms_sf_config_list[j].subframe_allocation >> 8)
                 & 0xFF);
            mbsfn_subframe_configuration->subframeAllocation.choice.oneFrame.buf[0] =
                ((m2ap_mbms_scheduling_information->mbms_area_config_list[i].mbms_sf_config_list[j].subframe_allocation >> 16)
                 & 0xFF);
