...
xnap_net_config_t Read_IPconfig_Xn(void)
{
  ...
  if ((XnParams[GNB_CONFIG_STRING_GNB_IP_ADDR_FOR_XNC_IDX].strptr == NULL) || (nc.gnb_port_for_XNC == 0)) {
    LOG_E(RRC, "Add gNB interface IP address and/or port in the configuration file!\n");
    exit(1);
  }
