...
#define GNB_CONFIG_STRING_BWP_LOCATIONANDBW   "locationAndBandwidth"

#define GNB_BWP_SCS_IDX               0
#define GNB_BWP_LOCATIONANDBW_IDX     1

#define GNBBWPPARAMS_DESC {                                                                  \
 {GNB_CONFIG_STRING_BWP_SCS,               NULL,   0,            .iptr=NULL,  .defintarrayval=0,            TYPE_INT,  0},  \
 {GNB_CONFIG_STRING_BWP_LOCATIONANDBW,     NULL,   0,            .iptr=NULL,  .defintarrayval=0,            TYPE_INT,  0},  \
}
