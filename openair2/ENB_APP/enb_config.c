...
void RCconfig_ssparam(void) {
  ...
  LOG_A(ENB_APP,"SS_Config:SSMode %d, hostIp=%s, Sysport=%d, Srbport=%d  Vngport=%d Drbport=%d\n",
                  RC.ss.mode, RC.ss.hostIp,RC.ss.Sysport,RC.ss.Srbport,RC.ss.Vngport,RC.ss.Drbport);
}
