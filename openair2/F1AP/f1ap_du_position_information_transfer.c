...
MessageDef                       *msg_p;
  ...
  //int i;
  /* GNB_CU_UE_F1AP_ID */
  F1AP_FIND_PROTOCOLIE_BY_ID(F1AP_PositioningInformationRequestIEs_t, ie, container,
  ...
  F1AP_FIND_PROTOCOLIE_BY_ID(F1AP_PositioningInformationRequestIEs_t, ie, container,
                             F1AP_ProtocolIE_ID_id_RequestedSRSTransmissionCharacteristics, true);
...
F1AP_F1AP_PDU_t                  pdu= {0};
  ...
  ie2->value.choice.GNB_DU_UE_F1AP_ID = f1ap_positioning_information_resp->gNB_DU_ue_id;//f1ap_get_du_ue_f1ap_id(DUtype, instance, resp->rnti);
...
/* SRSConfiguration */
  ...
  //ie4->value.choice.SFNInitialisationTime.buf = NULL ; //TODO adeel retrieve and add TYPE typedef struct BIT_STRING_s {uint8_t *buf;	size_t size;	int bits_unused;} BIT_STRING_t;
  //ie4->value.choice.SFNInitialisationTime.size =4;
...
int DU_send_POSITIONING_INFORMATION_FAILURE(instance_t instance, f1ap_positioning_information_failure_t *f1ap_positioning_information_failure){
 F1AP_F1AP_PDU_t                  pdu= {0};
  ...
  ie2->value.choice.GNB_DU_UE_F1AP_ID = f1ap_positioning_information_failure->gNB_DU_ue_id;//f1ap_get_du_ue_f1ap_id(DUtype, instance, resp->rnti);
