...
int CU_handle_POSITIONING_INFORMATION_RESPONSE(instance_t       instance,
                                        uint32_t         assoc_id,
                                        uint32_t         stream,
                                        F1AP_F1AP_PDU_t *pdu) {
  MessageDef                       *msg_p;
 ...
 f1ap_positioning_information_resp_t *f1ap_positioning_information_resp = &F1AP_POSITIONING_INFORMATION_RESP(msg_p);
  ...
  //int i;
  /* GNB_CU_UE_F1AP_ID */
  F1AP_FIND_PROTOCOLIE_BY_ID(F1AP_PositioningInformationResponseIEs_t, ie, container,
  ...
  // SRSConfiguration
  F1AP_FIND_PROTOCOLIE_BY_ID(F1AP_PositioningInformationResponseIEs_t, ie, container,
                             F1AP_ProtocolIE_ID_id_SRSConfiguration, false);


  // SFNInitialisationTime
  F1AP_FIND_PROTOCOLIE_BY_ID(F1AP_PositioningInformationResponseIEs_t, ie, container,
                             F1AP_ProtocolIE_ID_id_SFNInitialisationTime, false);
...
int CU_handle_POSITIONING_INFORMATION_FAILURE(instance_t       instance,
                                       uint32_t         assoc_id,
                                       uint32_t         stream,
                                       F1AP_F1AP_PDU_t *pdu) {
  MessageDef                       *msg_p;
  ...
  F1AP_FIND_PROTOCOLIE_BY_ID(F1AP_PositioningInformationFailureIEs_t, ie, container,
                             F1AP_ProtocolIE_ID_id_gNB_CU_UE_F1AP_ID, true);
