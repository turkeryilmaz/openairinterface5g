...
static void _adbgSysVT__SymbolTimingInfo_Type_Value(acpCtx_t _ctx, const union SymbolTimingInfo_Type_Value* p, enum SymbolTimingInfo_Type_Sel d)
{
...
static void _adbgSysVT__SymbolTimingInfo_Type(acpCtx_t _ctx, const struct SymbolTimingInfo_Type* p)
{
	_adbgSysVT__SymbolTimingInfo_Type_Value(_ctx, &p->v, p->d);
}
...
static void _adbgSysVT__SubFrameTiming_Type(acpCtx_t _ctx, const struct SubFrameTiming_Type* p)
{
	...
	_adbgSysVT__SymbolTimingInfo_Type(_ctx, &p->Symbol);
	adbgPrintLog(_ctx, " }");
}
