...
#define ATTACH_REQUEST_MAXIMUM_LENGTH                                                                                        \
  (EPS_ATTACH_TYPE_MAXIMUM_LENGTH + NAS_KEY_SET_IDENTIFIER_MAXIMUM_LENGTH + EPS_MOBILE_IDENTITY_MAXIMUM_LENGTH               \
   + UE_NETWORK_CAPABILITY_MAXIMUM_LENGTH + ESM_MESSAGE_CONTAINER_MAXIMUM_LENGTH + P_TMSI_SIGNATURE_MAXIMUM_LENGTH           \
   + EPS_MOBILE_IDENTITY_MAXIMUM_LENGTH + TRACKING_AREA_IDENTITY_MAXIMUM_LENGTH + DRX_PARAMETER_MAXIMUM_LENGTH               \
   + MS_NETWORK_CAPABILITY_MAXIMUM_LENGTH + MS_NETWORK_FEATURE_SUPPORT_MAXIMUM_LENGTH                                        \
   + LOCATION_AREA_IDENTIFICATION_MAXIMUM_LENGTH + TMSI_STATUS_MAXIMUM_LENGTH + MOBILE_STATION_CLASSMARK_2_MAXIMUM_LENGTH    \
   + MOBILE_STATION_CLASSMARK_3_MAXIMUM_LENGTH + SUPPORTED_CODEC_LIST_MAXIMUM_LENGTH + ADDITIONAL_UPDATE_TYPE_MAXIMUM_LENGTH \
