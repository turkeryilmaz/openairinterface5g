...
static void gtpv1uSendDlDeliveryStatus(instance_t instance, gtpv1u_DU_buffer_report_req_t *req)
{
  ...
  fillDlDeliveryStatusReport(&ext, req->buffer_availability, 0);
...
static int Gtpv1uHandleEchoReq(int h,
  ...
  return gtpv1uCreateAndSendMsg(h, peerIp, peerPort, GTP_ECHO_RSP, ntohl(msgHdr->teid), recovery, sizeof recovery, true, false, seq, 0, NULL, 0);
}
